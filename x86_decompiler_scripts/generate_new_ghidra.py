...
base_dir = "/home/weicheng/Documents/CS699_WASM/CS699_webassembly/new_compiled_benchmarks/em_output_O2"
...
"""
    ...
    if status != 0:
        new_code = generator.add_extra_declarations(new_code, output, ["DAT", "uRam"])
