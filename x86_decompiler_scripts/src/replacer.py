...
type_reg_exp = r"(void|int|char|short|long|int8_t|uint8_t|int16_t|uint16_t|int32_t|uint32_t|int64_t|uint64_t|struct|union|uint|uchar|int8|ushort|ulong|double|float|size_t|BF_KEY|EVP_PKEY_CTX)"
