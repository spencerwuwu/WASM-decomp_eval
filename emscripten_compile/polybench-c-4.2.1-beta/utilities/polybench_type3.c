# 1 "./polybench-c-4.2.1-beta/utilities/polybench_type3.c"
# 29 "./polybench-c-4.2.1-beta/utilities/polybench_type3.c"
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <unistd.h>
...
# 433 "./polybench-c-4.2.1-beta/utilities/polybench_type3.c"
...
void* polybench_alloc_data(unsigned long long int n, int elt_size)
{
  ...
  size_t val = n;
  val *= elt_size;
# 603 "./polybench-c-4.2.1-beta/utilities/polybench_type3.c"
  void* ret = (double*) malloc (val);
# 612 "./polybench-c-4.2.1-beta/utilities/polybench_type3.c"
  return ret;
}
