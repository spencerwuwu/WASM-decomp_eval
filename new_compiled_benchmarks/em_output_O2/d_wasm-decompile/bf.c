...
export function local_memcpy(a:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }, b:{ a:int, b:int, c:int, d:int, e:int, f:int, g:int, h:int }, c:int) {
  var d:int;
  var e:int;
  if (c <= 0) goto B_a;
  var f:int = c & 7;
...
export function BF_set_key(a:int, b:{ a:long, b:long, c:long, d:long, e:long, f:long, g:long, h:long, i:long }) {
  var d:int;
  var c:int = stack_pointer - 16;
  stack_pointer = c;
  memcpy(key_P, d = bf_init_P, 72);
  memcpy(key_S, d = bf_init_S, 4096);
  a = b + select_if(72, a, a >= 72);
  d = 0;
  var e:ubyte_ptr = b;
  loop L_a {
    var f:ubyte_ptr = e + 1;
                                                                                                  ...
                                                                                                  ((((c = 
                                                                                                        (e.d ^
                                                                                                         ((((d = 
                                                                                                               (e.c ^
                                                                                                                ((((c = (e.b ^
                                                                                                                         (((b = key_S) + ((d = d ^ f) >> 14 & 1020) + 1024)[0]:int +
                                                                                                                          (b + (d >> 22 & 1020))[0]:int ^
...
export function BF_cfb64_encrypt(a:ubyte_ptr, b:byte_ptr, c:int, d:int_ptr@1, e:int_ptr, f:int) {
  var i:int;
  var j:int;
...
export function blowfish_main():int {
  ...
  loop L_a {
    memcpy(
      ...
      in_key + d,
      b = 
        (i = select_if(39, b = select_if(5199, d, d <= 5199) - d, b >= 39)) +
        1);
    ...
    f = 0;
    loop L_d {
      c = c + ((a + 16 + b)[0]:ubyte != (h = (h = out_key) + e).a) +
          ((a + 16 + (b | 1))[0]:ubyte != h.b);
      b = b + 2;
      e = e + 2;
      f = f + 2;
      if (f != j) continue L_d;
    ...
    f = d + i;
    h = g + 1;
    if (k) { c = c + ((a + 16 + b)[0]:ubyte != ((j = out_key) + e)[0]:ubyte) }
    d = f + 1;
    g = h + i;
...
export function submain():int {
  ...
  endTimer[0]:double =
    (d = f64_convert_i32_s(c = a[14]:int) * 0.000001 +
         f64_convert_i64_s(a[6]:long));
  a[0]:double = d - startTimer[0]:double;
