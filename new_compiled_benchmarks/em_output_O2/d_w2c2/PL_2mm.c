...
void f8(PL2mmInstance*i,U32 l0,U32 l1,U32 l2,U32 l3,U32 l4,U32 l5,U32 l6,U32 l7,U32 l8,U32 l9) {
F64 l10=0;
U32 l11=0;
U32 l12=0;
U32 l13=0;
...
F64 sd0,sd1,sd2;
si0=l4;
sj1=4609434218613702656ULL;
i64_store(i->env__memory,(U64)si0,sj1);
si0=l5;
sj1=4608083138725491507ULL;
i64_store(i->env__memory,(U64)si0,sj1);
si0=l0;
si1=0U;
...
void f9(PL2mmInstance*i,U32 l0,U32 l1,U32 l2) {
U32 l3=0;
U32 l4=0;
U32 l5=0;
U32 l6=0;
...
void f10(PL2mmInstance*i,U32 l0,U32 l1,U32 l2,U32 l3,F64 l4,F64 l5,U32 l6,U32 l7,U32 l8,U32 l9,U32 l10) {
U32 l11=0;
F64 l12=0;
U32 l13=0;
U32 l14=0;
...
U32 f11(PL2mmInstance*i,U32 l0,U32 l1) {
U32 l2=0;
U32 l3=0;
U32 l4=0;
F64 l5=0;
...
si0=l3;
si1=l4;
sd1=f64_load(i->env__memory,(U64)si1+8U);
si2=l6;
si3=9600U;
si2+=si3;
sd2=f64_load(i->env__memory,(U64)si2);
...
si0=l3;
si1=l4;
sd1=f64_load(i->env__memory,(U64)si1+16U);
si2=l6;
si3=19200U;
si2+=si3;
sd2=f64_load(i->env__memory,(U64)si2);
...
U32 f12(PL2mmInstance*i,U64 l0,U32 l1) {
U32 si0,si1,si2;
U64 sj0,sj1,sj2;
sj0=l0;
si0=(U32)(sj0);
...
f8(i,l0,l1,l2,l3,l4,l5,l6,l7,l8,l9);
}
...
f10(i,l0,l1,l2,l3,l4,l5,l6,l7,l8,l9,l10);
}
