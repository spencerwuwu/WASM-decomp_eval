...
U32 env__memset(struct nussinovInstance*,U32,U32,U32);

U32 env__fwrite(struct nussinovInstance*,U32,U32,U32,U32);

U32 env__fiprintf(struct nussinovInstance*,U32,U32,U32);

U32 env__fputc(struct nussinovInstance*,U32,U32);

void env__free(struct nussinovInstance*,U32);

U32 env__polybench_alloc_data(struct nussinovInstance*,U32,U32,U32);

void f6(nussinovInstance*);
