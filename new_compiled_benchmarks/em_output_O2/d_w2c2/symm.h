...
U32 env__fwrite(struct symmInstance*,U32,U32,U32,U32);

U32 env__fiprintf(struct symmInstance*,U32,U32,U32);

U32 env__fputc(struct symmInstance*,U32,U32);

U32 env_____small_fprintf(struct symmInstance*,U32,U32,U32);

void env__free(struct symmInstance*,U32);

U32 env__polybench_alloc_data(struct symmInstance*,U32,U32,U32);

void f6(symmInstance*);
