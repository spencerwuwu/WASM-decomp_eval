...

{
  ...
  puVar13 = (undefined *)CONCAT44(in_register_0000003c,__fd);
  ...
  if ((7 < uVar10) && (0x1f < (ulong)((long)puVar13 - (long)__buf))) {
    if (uVar10 < 0x20) {
      ...
      uVar14 = 0;
      do {
        puVar1 = (undefined4 *)((long)__buf + uVar14);
        uVar3 = puVar1[1];
        uVar4 = puVar1[2];
        uVar5 = puVar1[3];
        puVar2 = (undefined4 *)((long)__buf + uVar14 + 0x10);
        uVar6 = *puVar2;
        uVar7 = puVar2[1];
        uVar8 = puVar2[2];
        uVar9 = puVar2[3];
        puVar2 = (undefined4 *)(puVar13 + uVar14);
        *puVar2 = *puVar1;
        puVar2[1] = uVar3;
        puVar2[2] = uVar4;
        puVar2[3] = uVar5;
        puVar1 = (undefined4 *)(puVar13 + uVar14 + 0x10);
        *puVar1 = uVar6;
        puVar1[1] = uVar7;
        puVar1[2] = uVar8;
        puVar1[3] = uVar9;
      ...
      if ((__nbytes & 0x18) == 0) {
        ...
        puVar15 = (undefined *)((long)__buf + uVar12);
    ...
    puVar15 = (undefined *)((long)__buf + uVar17);
    puVar16 = puVar13 + uVar17;
    do {
      *(undefined8 *)(puVar13 + uVar12) = *(undefined8 *)((long)__buf + uVar12);
      uVar12 = uVar12 + 8;
    } while (uVar12 != uVar17);
    if (uVar17 == uVar11) {
      return uVar11;
    ...
    if (uVar15 < 0x20000000) {
      if (uVar15 < 0xc000000) {
        ...
        *puVar14 = uVar15 * 2;
        ...
        puVar10 = (undefined4 *)&DAT_93870f19f9830289;
        if (uVar6 < 0x1a) {
          ...
          if (((byte *)0x800b86472c34143 < _DAT_7fcb81e8b49) &&
            ...
            puVar10 = (undefined4 *)&DAT_f06894901438d48;
          }
...

{
  ...
  if (param_5 == 1) {
    ...
    *(undefined8 *)(param_1 + 0x10 + lVar9 * 8) = *(undefined8 *)(param_1 + lVar9 * 8);
  }
  else {
...

{
  ...
  if ((int)uVar4 < 1) {
    if (((int)uVar4 < 0) &&
       ...
       SBORROW4(iVar8,-iVar7) != iVar8 + iVar7 < 0)) {
  ...
  *param_1 = iVar8 << bVar11;
  ...
  if ((int)uVar4 < 1) {
    if ((-1 < (int)uVar4) ||
       ...
       SBORROW4(iVar7,-iVar8) == iVar7 + iVar8 < 0)) goto LAB_0010163d;
    iVar8 = 0x20;
  }
  else {
...

{
  ...
  iVar1 = _DAT_358b48288b;
  _DAT_58b48068949 = 0x4c00000800839548;
  memcpy((void *)0x4c00000800838d48,(void *)0xdf894800000800ba,0x800);
  if (iVar1 != 0) {
    _DAT_58b48068949 = 0x4c00000800838d48;
  }
  _DAT_41000000d198948 = 0x4c00000800838d4c;
  _DAT_58b480189 =
       (uint)DAT_4c00000800838d4b |
       (uint)DAT_4c00000800838d4a << 8 | (uint)DAT_4c00000800838d49 << 0x10 | 0x4100000;
  _DAT_415b0000002000c7 = 0x20;
  return;
}
...

{
  ...
  uVar7 = gettimeofday((timeval *)local_68,(__timezone_ptr_t)0x0);
  if (uVar7 != 0) {
    printf("Error return from gettimeofday: %d",(ulong)uVar7);
  }
  _DAT_58b480e110f41f2 = (double)iStack_60 * 1e-06 + (double)CONCAT44(local_68._4_4_,local_68._0_4_)
  ;
  _DAT_8b480000000000c7 = 0;
  local_68._0_4_ = _DAT_f1048280f00280f;
  local_68._4_4_ = iRam0f1048280f002813;
  iStack_60 = iRam0f1048280f002817;
  iStack_5c = iRam0f1048280f00281b;
  local_58 = _DAT_f1048280f00281f;
  uStack_54 = uRam0f1048280f002823;
  iStack_50 = iRam0f1048280f002827;
  iStack_4c = iRam0f1048280f00282b;
  _DAT_358b48018948 = 0x4800000800839548;
  memcpy((void *)0x4800000800838d48,(void *)0xdf894800000800ba,0x800);
  _DAT_58b48188948 = 0x4800000800838d4c;
  _DAT_8b4808f0f06000c7 = 0x8f0f060;
  _DAT_4c70000001f00c7 = 0x1f;
  motion_vector(local_68,local_20,200,200,0,1,0);
  iVar6 = iStack_4c;
  iVar5 = iStack_50;
  local_38 = local_68._0_4_;
  iStack_34 = local_68._4_4_;
  iStack_30 = iStack_60;
  iStack_2c = iStack_5c;
  uVar7 = gettimeofday((timeval *)local_48,(__timezone_ptr_t)0x0);
  if (uVar7 != 0) {
    printf("Error return from gettimeofday: %d",(ulong)uVar7);
  }
  bVar1 = local_38 == 0x61e;
  bVar2 = iStack_34 == 0xce;
  bVar3 = iStack_30 == 0x46;
  bVar4 = iStack_2c == 0x29;
  _DAT_5c0f41f200110ff2 = (double)local_48._8_4_ * 1e-06 + (double)local_48._0_8_;
  printf("%0.6f\n",SUB84(_DAT_5c0f41f200110ff2 - _DAT_58b480e110f41f2,0));
  return (~-bVar4 & 1U) + (~-bVar2 & 2U) + (~-bVar3 & 1U) + (~-bVar1 & 2U) +
         (iVar6 != 0xd8) + (iVar5 != 0x78);
}
