...
typedef pointer pointer __((offset(0x6a3)));
...
typedef pointer pointer __((offset(0x5c1)));

typedef pointer pointer __((offset(0x6b)));

typedef pointer pointer __((offset(0x412)));

typedef pointer pointer __((offset(0x9e)));
