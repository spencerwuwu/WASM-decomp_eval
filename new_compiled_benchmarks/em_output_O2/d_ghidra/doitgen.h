...
typedef pointer pointer __((offset(0x84e)));

typedef pointer pointer __((offset(0x768)));
...
typedef pointer pointer __((offset(0x2d2)));
...
typedef pointer pointer __((offset(0x2f6)));

typedef pointer pointer __((offset(0x714)));
