...
typedef pointer pointer __((offset(0x85)));
...
typedef pointer pointer __((offset(0x4d)));

typedef pointer pointer __((offset(0x31a)));

typedef pointer pointer __((offset(0x2df)));
...
typedef pointer pointer __((offset(0x163)));
