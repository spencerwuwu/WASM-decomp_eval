...
typedef pointer pointer __((offset(0x2eb)));

typedef pointer pointer __((offset(0x2c)));

typedef pointer pointer __((offset(0x3e0)));

typedef pointer pointer __((offset(0x2fc)));
