...
typedef pointer pointer __((offset(0x4d3)));

typedef pointer pointer __((offset(0x511)));
...
typedef pointer pointer __((offset(0x4ba)));

typedef pointer pointer __((offset(0x599)));
