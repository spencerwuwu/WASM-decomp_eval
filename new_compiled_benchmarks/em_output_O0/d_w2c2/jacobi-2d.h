...
U32 env__strcmp(struct jacobi2dInstance*,U32,U32);

void env__free(struct jacobi2dInstance*,U32);

U32 env__fprintf(struct jacobi2dInstance*,U32,U32,U32);

U32 env__polybench_alloc_data(struct jacobi2dInstance*,U32,U32,U32);

void f4(jacobi2dInstance*);

void f5(jacobi2dInstance*);

void f6(jacobi2dInstance*,U32,U32,U32,U32);

U32 f7(jacobi2dInstance*,U32,U32);

void f8(jacobi2dInstance*,U32,U32,U32);

void f9(jacobi2dInstance*,U32,U32);
