...
U32 env__fprintf(struct PL2mmInstance*,U32,U32,U32);

U32 env__strcmp(struct PL2mmInstance*,U32,U32);

void env__free(struct PL2mmInstance*,U32);

U32 env__polybench_alloc_data(struct PL2mmInstance*,U32,U32,U32);

void f4(PL2mmInstance*);

void f5(PL2mmInstance*);

void f6(PL2mmInstance*,U32,U32,U32,U32,U32,U32,U32,U32,U32,U32);

void f7(PL2mmInstance*,U32,U32,U32);

void f8(PL2mmInstance*,U32,U32,U32,U32,F64,F64,U32,U32,U32,U32,U32);

U32 f9(PL2mmInstance*,U32,U32);

U32 f10(PL2mmInstance*,U64,U32);
