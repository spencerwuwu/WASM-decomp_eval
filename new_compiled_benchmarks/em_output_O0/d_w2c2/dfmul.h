...
U32 env__printf(struct dfmulInstance*,U32,U32);

U32 env__gettimeofday(struct dfmulInstance*,U32,U32);

void env__setTempRet0(struct dfmulInstance*,U32);

void f3(dfmulInstance*);

void f4(dfmulInstance*);

void f5(dfmulInstance*,U64,U32,U32);

void f6(dfmulInstance*,U64,U64,U32,U32);

void f7(dfmulInstance*,U32);

U32 f8(dfmulInstance*,U64);

U32 f9(dfmulInstance*,U64);

U64 f10(dfmulInstance*,U64);

U32 f11(dfmulInstance*,U64);
...
void f24(dfmulInstance*,U32,U32,U32,U32,U32,U32);

U32 f25(dfmulInstance*,U32,U32);

U32 f26(dfmulInstance*,U32,U32);

U32 f27(dfmulInstance*,U32,U32);

U32 f28(dfmulInstance*,U32,U32);
