...
U32 env__strcmp(struct jacobi1dInstance*,U32,U32);

void env__free(struct jacobi1dInstance*,U32);

U32 env__fprintf(struct jacobi1dInstance*,U32,U32,U32);

U32 env__polybench_alloc_data(struct jacobi1dInstance*,U32,U32,U32);

void f4(jacobi1dInstance*);
...
U32 f10(jacobi1dInstance*,U64,U32);
