...
U32*GOTX2Emem__inmvfs;
U32*GOTX2Emem__inPMV;
U32*GOTX2Emem__outmvfs;
U32*GOTX2Emem__outPMV;
...
U32 env__printf(struct mpeg2Instance*,U32,U32);

U32 env__gettimeofday(struct mpeg2Instance*,U32,U32);

void f2(mpeg2Instance*);

void f3(mpeg2Instance*);

U32 f4(mpeg2Instance*,U32,U32,U32);

void f5(mpeg2Instance*);

U32 f6(mpeg2Instance*,U32);

U32 f7(mpeg2Instance*);

U32 f8(mpeg2Instance*,U32);

void f9(mpeg2Instance*,U32);

U32 f10(mpeg2Instance*);

U32 f11(mpeg2Instance*);

void f12(mpeg2Instance*,U32,U32,U32,U32,U32,U32,U32,U32,U32,U32);

void f13(mpeg2Instance*,U32,U32,U32,U32,U32,U32,U32);

void f14(mpeg2Instance*,U32,U32,U32,U32,U32);

void f15(mpeg2Instance*);

U32 f16(mpeg2Instance*);

F64 f17(mpeg2Instance*);
