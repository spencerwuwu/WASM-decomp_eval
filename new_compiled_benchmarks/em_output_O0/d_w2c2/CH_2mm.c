...
void f4(CH2mmInstance*i) {
L0:;
}

void f5(CH2mmInstance*i) {
L0:;
}

U32 f6(CH2mmInstance*i,U32 l0,U32 l1) {
U32 l2=0;
U32 l3=0;
U32 l4=0;
U32 l5=0;
...
si8=l30;
si9=l31;
f7(i,si0,si1,si2,si3,si4,si5,si6,si7,si8,si9);
si0=l4;
si0=i32_load(i->env__memory,(U64)si0+52U);
l38=si0;
si0=l4;
...
void f7(CH2mmInstance*i,U32 l0,U32 l1,U32 l2,U32 l3,U32 l4,U32 l5,U32 l6,U32 l7,U32 l8,U32 l9) {
U32 l10=0;
U32 l11=0;
U32 l12=0;
U32 l13=0;
...
void f8(CH2mmInstance*i,U32 l0,U32 l1,U32 l2,U32 l3,F64 l4,F64 l5,U32 l6,U32 l7,U32 l8,U32 l9,U32 l10) {
U32 l11=0;
U32 l12=0;
U32 l13=0;
U32 l14=0;
...
void f9(CH2mmInstance*i,U32 l0,U32 l1,U32 l2) {
U32 l3=0;
U32 l4=0;
U32 l5=0;
U32 l6=0;
...
U32 f10(CH2mmInstance*i,U64 l0,U32 l1) {
U32 si0,si1,si2;
U64 sj0,sj1,sj2;
sj0=l0;
si0=(U32)(sj0);
...
static void CH2mmInitImports(CH2mmInstance* i, void* resolve(const char* module, const char* name)) {
...
void CH2mmInstantiate(CH2mmInstance* i, void* resolve(const char* module, const char* name)) {
CH2mmInitImports(i, resolve);
}

void CH2mmFreeInstance(CH2mmInstance* i) {
}
