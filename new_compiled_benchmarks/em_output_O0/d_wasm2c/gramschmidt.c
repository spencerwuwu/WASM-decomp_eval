...
static void w2c_gramschmidt_kernel_gramschmidt(w2c_gramschmidt*, u32, u32, u32, u32, u32);
...
u32 w2c_gramschmidt_submain_0(w2c_gramschmidt* instance, u32 var_p0, u32 var_p1) {
  ...
  var_i3 = var_l24;
  var_i4 = var_l25;
  w2c_gramschmidt_kernel_gramschmidt(instance, var_i0, var_i1, var_i2, var_i3, var_i4);
  var_i0 = var_l4;
