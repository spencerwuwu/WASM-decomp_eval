...
void wasm2c_dfmul_instantiate(w2c_dfmul*, struct w2c_GOT0x2Emem*, struct w2c_env*);
void wasm2c_dfmul_free(w2c_dfmul*);
...
extern const u32 wasm2c_dfmul_min_env_memory;
extern const u32 wasm2c_dfmul_max_env_memory;

/* export: '__wasm_call_ctors' */
void w2c_dfmul_0x5F_wasm_call_ctors(w2c_dfmul*);

/* export: '__wasm_apply_data_relocs' */
void w2c_dfmul_0x5F_wasm_apply_data_relocs(w2c_dfmul*);

/* export: 'shift64RightJamming' */
void w2c_dfmul_shift64RightJamming(w2c_dfmul*, u32, u32, u32, u32);

/* export: 'mul64To128' */
void w2c_dfmul_mul64To128(w2c_dfmul*, u32, u32, u32, u32, u32, u32);

/* export: 'float_raise' */
void w2c_dfmul_float_raise(w2c_dfmul*, u32);

/* export: 'float_exception_flags' */
u32* w2c_dfmul_float_exception_flags(w2c_dfmul* instance);

/* export: 'float64_is_nan' */
u32 w2c_dfmul_float64_is_nan(w2c_dfmul*, u32, u32);

/* export: 'float64_is_signaling_nan' */
u32 w2c_dfmul_float64_is_signaling_nan(w2c_dfmul*, u32, u32);

/* export: 'extractFloat64Frac' */
u32 w2c_dfmul_extractFloat64Frac(w2c_dfmul*, u32, u32);

/* export: 'extractFloat64Exp' */
u32 w2c_dfmul_extractFloat64Exp(w2c_dfmul*, u32, u32);
...
/* export: 'submain' */
u32 w2c_dfmul_submain(w2c_dfmul*);
...
void w2c_dfmul_orig0x24shift64RightJamming(w2c_dfmul*, u64, u32, u32);

/* export: 'orig$mul64To128' */
void w2c_dfmul_orig0x24mul64To128(w2c_dfmul*, u64, u64, u32, u32);

/* export: 'orig$float64_is_nan' */
u32 w2c_dfmul_orig0x24float64_is_nan(w2c_dfmul*, u64);

/* export: 'orig$float64_is_signaling_nan' */
u32 w2c_dfmul_orig0x24float64_is_signaling_nan(w2c_dfmul*, u64);

/* export: 'orig$extractFloat64Frac' */
u64 w2c_dfmul_orig0x24extractFloat64Frac(w2c_dfmul*, u64);

/* export: 'orig$extractFloat64Exp' */
u32 w2c_dfmul_orig0x24extractFloat64Exp(w2c_dfmul*, u64);
...
f64 w2c_dfmul_orig0x24ullong_to_double(w2c_dfmul*, u64);
