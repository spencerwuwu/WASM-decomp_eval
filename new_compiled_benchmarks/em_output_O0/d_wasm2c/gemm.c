...
static void w2c_gemm_0x5F_wasm_call_ctors_0(w2c_gemm*);
static void w2c_gemm_0x5F_wasm_apply_data_relocs_0(w2c_gemm*);
static void w2c_gemm_kernel_gemm_0(w2c_gemm*, u32, u32, u32, f64, f64, u32, u32, u32);
static u32 w2c_gemm_submain_0(w2c_gemm*, u32, u32);
static void w2c_gemm_init_array(w2c_gemm*, u32, u32, u32, u32, u32, u32, u32, u32);
static void w2c_gemm_print_array(w2c_gemm*, u32, u32, u32);
static u32 w2c_gemm_legalfunc0x24polybench_alloc_data(w2c_gemm*, u64, u32);

FUNC_TYPE_T(w2c_gemm_t0) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";
FUNC_TYPE_T(w2c_gemm_t1) = "\xcd\xad\x8f\x6a\xaf\x3e\xd0\x86\xf0\x9a\xd7\xf0\xc7\x0d\x48\x9f\x27\x59\xf3\x8d\x71\xa1\x81\xa8\xcc\x06\x53\x98\x62\x34\xaa\xf5";
FUNC_TYPE_T(w2c_gemm_t2) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_gemm_t3) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_gemm_t4) = "\x38\xc7\xdc\xf7\x1f\x78\xba\x5e\xf9\x22\xc2\xc6\x6d\x60\xb2\xeb\x52\x0f\xb4\xec\x36\xf3\x77\xe9\x3f\x7f\x2b\x28\xb2\x40\xd4\xe0";
FUNC_TYPE_T(w2c_gemm_t5) = "\x90\x8f\x81\x00\x2b\xca\x26\x3d\x5e\x4f\x40\xca\x14\xfd\x00\xb8\xf1\x65\x87\x21\x35\xe3\xfd\x4b\x84\x6b\x9f\xec\xd8\xfb\x54\x1d";
FUNC_TYPE_T(w2c_gemm_t6) = "\x78\xde\x71\xb6\x49\x9a\x33\x9d\xd3\x70\x88\x4c\x50\xd4\xea\xdf\xe1\x2a\x18\x12\xf6\xf3\x64\xf7\xea\x4f\x94\x19\xa7\x20\x28\xe8";
FUNC_TYPE_T(w2c_gemm_t7) = "\xc1\x35\x64\x94\x2d\x55\x73\x56\xf4\xe1\x63\x0d\x0e\xe1\x22\x79\x32\x48\xe9\x1a\x10\x0b\x2b\x94\x08\xe2\xbe\x33\x0f\x6d\x15\x99";

static void init_globals(w2c_gemm* instance) {
}

static const u8 data_segment_data_w2c_gemm_0x2Erodata[] = {
...
static void init_memories(w2c_gemm* instance) {
  LOAD_DATA((*instance->w2c_env_memory), (*instance->w2c_env_0x5F_memory_base), data_segment_data_w2c_gemm_0x2Erodata, 88);
}

static void init_data_instances(w2c_gemm *instance) {
}

/* export: '__wasm_call_ctors' */
void w2c_gemm_0x5F_wasm_call_ctors(w2c_gemm* instance) {
  return w2c_gemm_0x5F_wasm_call_ctors_0(instance);
}

/* export: '__wasm_apply_data_relocs' */
void w2c_gemm_0x5F_wasm_apply_data_relocs(w2c_gemm* instance) {
  return w2c_gemm_0x5F_wasm_apply_data_relocs_0(instance);
}

/* export: 'kernel_gemm' */
void w2c_gemm_kernel_gemm(w2c_gemm* instance, u32 var_p0, u32 var_p1, u32 var_p2, f64 var_p3, f64 var_p4, u32 var_p5, u32 var_p6, u32 var_p7) {
  return w2c_gemm_kernel_gemm_0(instance, var_p0, var_p1, var_p2, var_p3, var_p4, var_p5, var_p6, var_p7);
}

/* export: 'submain' */
u32 w2c_gemm_submain(w2c_gemm* instance, u32 var_p0, u32 var_p1) {
  return w2c_gemm_submain_0(instance, var_p0, var_p1);
}

static void init_instance_import(w2c_gemm* instance, struct w2c_GOT0x2Emem* w2c_GOT0x2Emem_instance, struct w2c_env* w2c_env_instance){
...
const u32 wasm2c_gemm_min_env_memory = 1;
const u32 wasm2c_gemm_max_env_memory = 4294967295;

void wasm2c_gemm_instantiate(w2c_gemm* instance, struct w2c_GOT0x2Emem* w2c_GOT0x2Emem_instance, struct w2c_env* w2c_env_instance) {
...
void wasm2c_gemm_free(w2c_gemm* instance) {
}

wasm_rt_func_type_t wasm2c_gemm_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
...
void w2c_gemm_0x5F_wasm_call_ctors_0(w2c_gemm* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

void w2c_gemm_0x5F_wasm_apply_data_relocs_0(w2c_gemm* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

void w2c_gemm_kernel_gemm_0(w2c_gemm* instance, u32 var_p0, u32 var_p1, u32 var_p2, f64 var_p3, f64 var_p4, u32 var_p5, u32 var_p6, u32 var_p7) {
  u32 var_l8 = 0, var_l9 = 0, var_l10 = 0, var_l11 = 0, var_l12 = 0, var_l13 = 0, var_l14 = 0, var_l15 = 0, 
      ...
      var_l24 = 0, var_l25 = 0, var_l26 = 0, var_l28 = 0, var_l29 = 0, var_l30 = 0, var_l31 = 0, var_l32 = 0, 
      var_l33 = 0, var_l34 = 0, var_l35 = 0, var_l36 = 0, var_l39 = 0, var_l40 = 0, var_l41 = 0, var_l42 = 0, 
      var_l43 = 0, var_l44 = 0, var_l45 = 0, var_l46 = 0, var_l47 = 0, var_l48 = 0, var_l49 = 0, var_l50 = 0, 
      var_l51 = 0, var_l52 = 0, var_l53 = 0, var_l54 = 0, var_l55 = 0, var_l56 = 0, var_l57 = 0, var_l59 = 0, 
      ...
      var_l78 = 0, var_l80 = 0, var_l81 = 0, var_l82 = 0, var_l83 = 0, var_l84 = 0, var_l85 = 0, var_l86 = 0, 
      var_l87 = 0, var_l88 = 0, var_l92 = 0, var_l93 = 0, var_l94 = 0, var_l95 = 0, var_l96 = 0, var_l97 = 0, 
      var_l98 = 0, var_l99 = 0, var_l100 = 0;
  f64 var_l27 = 0, var_l37 = 0, var_l38 = 0, var_l58 = 0, var_l68 = 0, var_l69 = 0, var_l79 = 0, var_l89 = 0, 
      var_l90 = 0, var_l91 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  f64 var_d0, var_d1;
...
u32 w2c_gemm_submain_0(w2c_gemm* instance, u32 var_p0, u32 var_p1) {
  u32 var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l9 = 0, var_l10 = 0, 
      var_l12 = 0, var_l13 = 0, var_l15 = 0, var_l16 = 0, var_l17 = 0, var_l18 = 0, var_l19 = 0, var_l20 = 0, 
      var_l21 = 0, var_l22 = 0, var_l23 = 0, var_l24 = 0, var_l25 = 0, var_l26 = 0, var_l27 = 0, var_l28 = 0, 
      var_l29 = 0, var_l30 = 0, var_l31 = 0, var_l34 = 0, var_l35 = 0, var_l36 = 0, var_l37 = 0, var_l38 = 0, 
      ...
      var_l55 = 0, var_l56 = 0, var_l57 = 0, var_l58 = 0;
  u64 var_l8 = 0, var_l11 = 0, var_l14 = 0;
  f64 var_l32 = 0, var_l33 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1, var_i2, var_i3, var_i4, var_i5, var_i6, var_i7;
  u64 var_j0;
  f64 var_d0, var_d3, var_d4;
  var_i0 = (*instance->w2c_env_0x5F_stack_pointer);
  var_l2 = var_i0;
  var_i0 = 64u;
  var_l3 = var_i0;
  ...
  var_j0 = var_l8;
  var_i1 = var_l9;
  var_i0 = w2c_gemm_legalfunc0x24polybench_alloc_data(instance, var_j0, var_i1);
  var_l10 = var_i0;
  var_i0 = var_l4;
  var_i1 = var_l10;
  i32_store(instance->w2c_env_memory, (u64)(var_i0) + 20, var_i1);
  ...
  var_i6 = var_l21;
  var_i7 = var_l22;
  w2c_gemm_init_array(instance, var_i0, var_i1, var_i2, var_i3, var_i4, var_i5, var_i6, var_i7);
  var_i0 = var_l4;
  var_i0 = i32_load(instance->w2c_env_memory, (u64)(var_i0) + 52u);
  var_l29 = var_i0;
  var_i0 = var_l4;
  ...
  var_i6 = var_l35;
  var_i7 = var_l36;
  w2c_gemm_kernel_gemm_0(instance, var_i0, var_i1, var_i2, var_d3, var_d4, var_i5, var_i6, var_i7);
  var_i0 = var_l4;
  var_i0 = i32_load(instance->w2c_env_memory, (u64)(var_i0) + 60u);
  var_l37 = var_i0;
  var_i0 = 42u;
  ...
  var_i1 = var_l51;
  var_i2 = var_l52;
  w2c_gemm_print_array(instance, var_i0, var_i1, var_i2);
  var_B0:;
  var_i0 = var_l4;
  var_i0 = i32_load(instance->w2c_env_memory, (u64)(var_i0) + 20u);
  var_l53 = var_i0;
...
void w2c_gemm_init_array(w2c_gemm* instance, u32 var_p0, u32 var_p1, u32 var_p2, u32 var_p3, u32 var_p4, u32 var_p5, u32 var_p6, u32 var_p7) {
  u32 var_l8 = 0, var_l9 = 0, var_l10 = 0, var_l11 = 0, var_l13 = 0, var_l15 = 0, var_l16 = 0, var_l17 = 0, 
      ...
      var_l34 = 0, var_l35 = 0, var_l36 = 0, var_l37 = 0, var_l39 = 0, var_l42 = 0, var_l43 = 0, var_l44 = 0, 
      ...
      var_l77 = 0, var_l78 = 0, var_l79 = 0, var_l81 = 0, var_l84 = 0, var_l85 = 0, var_l86 = 0, var_l87 = 0, 
      ...
      var_l120 = 0, var_l121 = 0, var_l123 = 0, var_l126 = 0, var_l127 = 0, var_l128 = 0, var_l129 = 0, var_l130 = 0, 
      var_l131 = 0, var_l132 = 0, var_l133 = 0, var_l134 = 0, var_l135 = 0, var_l136 = 0, var_l137 = 0, var_l138 = 0, 
      var_l139 = 0, var_l140 = 0;
  f64 var_l12 = 0, var_l14 = 0, var_l38 = 0, var_l40 = 0, var_l41 = 0, var_l80 = 0, var_l82 = 0, var_l83 = 0, 
      var_l122 = 0, var_l124 = 0, var_l125 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  f64 var_d0, var_d1;
  var_i0 = (*instance->w2c_env_0x5F_stack_pointer);
...
void w2c_gemm_print_array(w2c_gemm* instance, u32 var_p0, u32 var_p1, u32 var_p2) {
...
u32 w2c_gemm_legalfunc0x24polybench_alloc_data(w2c_gemm* instance, u64 var_p0, u32 var_p1) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1, var_i2;
