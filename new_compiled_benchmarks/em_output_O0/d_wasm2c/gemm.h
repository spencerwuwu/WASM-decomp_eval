...
void wasm2c_gemm_instantiate(w2c_gemm*, struct w2c_GOT0x2Emem*, struct w2c_env*);
void wasm2c_gemm_free(w2c_gemm*);
...
extern const u32 wasm2c_gemm_min_env_memory;
extern const u32 wasm2c_gemm_max_env_memory;

/* export: '__wasm_call_ctors' */
void w2c_gemm_0x5F_wasm_call_ctors(w2c_gemm*);

/* export: '__wasm_apply_data_relocs' */
void w2c_gemm_0x5F_wasm_apply_data_relocs(w2c_gemm*);

/* export: 'kernel_gemm' */
void w2c_gemm_kernel_gemm(w2c_gemm*, u32, u32, u32, f64, f64, u32, u32, u32);

/* export: 'submain' */
u32 w2c_gemm_submain(w2c_gemm*, u32, u32);
