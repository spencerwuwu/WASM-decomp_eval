...
int64_t* b = stack_pointer;
int64_t c = 32;
{* d (long,)a (int,)b (int,)c (int,)d (int,)e (long)f } = b - c;
stack_pointer = d;
d.e = a;
int64_t e = d.e;
if (e) goto B_b;
...
int64_t* c = stack_pointer;
int64_t d = 32;
{* e (int,)a (int,)b (long,)c (long,)d (long)e } = c - d;
stack_pointer = e;
e.d = a;
e.c = b;
long f = e.d;
...
int64_t ea = 1;
int64_t* fa = da & ea;
int64_t ga = (int64_t)c[7];
int64_t* ha = ga + fa;
c[7] = ha;
int64_t ia = (int64_t)c[6];
int64_t ja = 1;
int64_t* ka = ia + ja;
c[6] = ka;
//continue L_b;
