...

{
  ...
  for (local_2c = 0; (int)local_2c < (int)local_1c; local_2c = local_2c + 1) {
    for (local_28 = 0; local_28 < 4; local_28 = local_28 + 1) {
      *(int *)((long)local_28 * 0x1e0 + 0x48000001e0c96948 + (long)(int)local_2c * 4) =
           *(int *)(param_2 + (long)(int)(local_28 + local_2c * 4) * 4);
    }
  }
  local_2c = local_1c;
  while( 1 ) {
    ...
    if ((int)local_2c % (int)local_1c != 0) {
      ...
      local_48[1] = *(int *)((long)(int)(local_2c - 1) * 4 + -0x76fffffe1f777995);
      local_48[2] = *(int *)((long)(int)(local_2c - 1) * 4 + -0x76fffffc3f7777b5);
      local_48[3] = *(int *)((long)(int)(local_2c - 1) * 4 + -0x76fffffa5f7775d5);
    }
  ...
  SubByte(*(int *)((long)(int)(local_2c - 1) * 4 + -0x17fffffe1f774195));
}
