...
int64_t expf(int128_t a1);
int64_t fprintf(int64_t a1, char * a2, int64_t a3, int64_t a4, int128_t a5);
int64_t free(float32_t (*a1)[1]);
void init_array(uint32_t w, uint32_t h, float32_t * alpha, float32_t (*imgIn)[1], float32_t (*imgOut)[1]);
...
int64_t powf(int128_t a1);
void print_array(uint32_t w, uint32_t h, float32_t (*imgOut)[1]);
int64_t strcmp(int64_t a1, int64_t * a2, float32_t (*a3)[1], float32_t (*a4)[1], float32_t (*a5)[1], int64_t a6, int128_t a7);
int32_t submain(int32_t argc, char ** argv);

// --------------------- Global Variables ---------------------

int64_t g1 = 0x4e494745423d3d00; // 0xb5c

// ------------------------ Functions -------------------------

// Address range: 0x0 - 0x840
int64_t kernel_deriche(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6) {
...
// Address range: 0x840 - 0x941
// Line range:    158 - 195
int32_t submain(int32_t argc, char ** argv) {
    int64_t v1 = polybench_alloc_data(0x870000, 4); // 0x867
    int64_t v2 = polybench_alloc_data(0x870000, 4); // 0x87a
    int64_t v3 = polybench_alloc_data(0x870000, 4); // 0x88d
    int64_t v4 = polybench_alloc_data(0x870000, 4); // 0x8a0
    float32_t alpha; // bp-36, 0x840
    init_array(0x1000, 2160, &alpha, &((float32_t (*)[1][1])v1)[0], &((float32_t (*)[1][1])v2)[0]);
    int128_t v5 = __asm_movss((int32_t)alpha); // 0x8c6
    if (argc < 43) {
        // 0x915
        free(&((float32_t (*)[1][1])v1)[0]);
        free(&((float32_t (*)[1][1])v2)[0]);
        free(&((float32_t (*)[1][1])v3)[0]);
        free((float32_t (*)[1])v4);
        return 0;
    }
    int64_t strcmp_rc = strcmp(2160, &g1, (float32_t (*)[1])v1, (float32_t (*)[1])v2, (float32_t (*)[1])v3, v4, v5); // 0x8f8
    if ((int32_t)strcmp_rc == 0) {
        // 0x906
        print_array(0x1000, 2160, &((float32_t (*)[1][1])v2)[0]);
    }
    // 0x915
    free(&((float32_t (*)[1][1])v1)[0]);
    free(&((float32_t (*)[1][1])v2)[0]);
...
// Address range: 0x950 - 0xa02
// Line range:    26 - 38
void init_array(uint32_t w, uint32_t h, float32_t * alpha, float32_t (*imgIn)[1], float32_t (*imgOut)[1]) {
    // 0x950
    *alpha = (float32_t)(int32_t)__asm_movss_1(__asm_movss(0x3e800000));
    if (w <= 0) {
        // 0xa00
        return;
    }
    ...
    if (h > 0) {
        // 0x99c
        v4 = 0x21c0 * v1 + (int64_t)imgIn;
        v2 = 0;
        v5 = 991 * v2 + 313 * v1;
        v6 = __asm_cvtsi2ss((int32_t)((0x100000000 * v5 | v5 & 0xffff) % 0x10000));
        v3 = __asm_movss_1(__asm_divss(v6, __asm_movss(*(int32_t *)2904)));
        *(int32_t *)(v4 + 4 * v2) = (int32_t)v3;
        v2++;
        while (v2 != (int64_t)h) {
            // 0x99c
            v5 = 991 * v2 + 313 * v1;
...
// Address range: 0xa10 - 0xb47
// Line range:    44 - 59
void print_array(uint32_t w, uint32_t h, float32_t (*imgOut)[1]) {
    int64_t v1 = (int64_t)imgOut;
    int64_t v2; // 0xa10
    int128_t v3; // 0xa10
    fprintf(*(int64_t *)*(int64_t *)2601, "==BEGIN DUMP_ARRAYS==\n", v1, v2, v3);
    int64_t stream = *(int64_t *)*(int64_t *)2625; // 0xa41
    fprintf(stream, "begin dump: %s", (int64_t)"imgOut", v2, v3);
    int64_t v4; // 0xa10
    int128_t v5; // 0xa10
    if (w > 0) {
        int64_t v6 = 0;
        int128_t v7; // 0xa10
        int128_t v8 = v7; // 0xa79
        int64_t v9; // 0xa10
        int64_t v10 = v9; // 0xa79
        int64_t v11; // 0xa10
        int64_t v12; // 0xa10
        int64_t v13; // 0xa10
        int32_t v14; // 0xa86
        ...
        if (h > 0) {
            // 0xa7f
            v13 = 0x21c0 * v6 + (0x100000000 * v1 >> 32);
            v12 = 0;
            v14 = (int32_t)v6 * h + (int32_t)v12;
            v15 = (0x100000000 * (int64_t)(v14 >> 31) | (int64_t)v14) % 20;
            v16 = v15 & 0xffffffff;
            if ((int32_t)v15 == 0) {
                // 0xa9a
                fprintf(*(int64_t *)*(int64_t *)2721, "\n", v16, 20, v7);
            }
            // 0xab2
            v17 = __asm_cvtss2sd(__asm_movss(*(int32_t *)(v13 + 4 * v12)));
            fprintf(*(int64_t *)*(int64_t *)2745, "%0.2f ", v16, v12, v17);
            v11 = v12 + 1;
            v18 = v17;
            v8 = v17;
            v10 = v12;
    ...
    int64_t stream2 = *(int64_t *)*(int64_t *)2833; // 0xb11
    fprintf(stream2, "\nend   dump: %s\n", (int64_t)"imgOut", v4, v5);
    int64_t stream3 = *(int64_t *)*(int64_t *)2864; // 0xb30
