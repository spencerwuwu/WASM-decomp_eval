...
int64_t init_array(int64_t a1, int64_t a2);
...
void print_array(uint32_t n, float64_t (*u)[1]);
int64_t strcmp(int64_t a1, int64_t a2);
int32_t submain(int32_t argc, char ** argv);

// --------------------- Global Variables ---------------------

int64_t g1 = 0x322e3025000a0075; // 0xad6

// ------------------------ Functions -------------------------

// Address range: 0x0 - 0x85
int64_t init_array(int64_t a1, int64_t a2) {
    uint32_t v1 = (int32_t)a1; // 0x15
    if (v1 <= 0) {
        // 0x83
        return 0;
    }
    ...
    int64_t v2 = 0;
    int64_t v3 = 0;
    int128_t v4 = __asm_cvtsi2sd((int32_t)v2 + v1 - (int32_t)v3); // 0x3a
    int64_t v5 = __asm_movsd_1(__asm_divsd(v4, __asm_cvtsi2sd(v1))); // 0x5d
    *(int64_t *)(0x1f40 * v2 + a2 + 8 * v3) = v5;
    v3++;
    while (v3 != result) {
        // 0x31
        v4 = __asm_cvtsi2sd((int32_t)v2 + v1 - (int32_t)v3);
        v5 = __asm_movsd_1(__asm_divsd(v4, __asm_cvtsi2sd(v1)));
        *(int64_t *)(0x1f40 * v2 + a2 + 8 * v3) = v5;
        v3++;
    }
    // 0x75
...
// Address range: 0x90 - 0x1c0
// Line range:    42 - 57
void print_array(uint32_t n, float64_t (*u)[1]) {
    // 0x90
    int64_t v1; // 0x90
    int128_t v2; // 0x90
    fprintf(*(int64_t *)*(int64_t *)166, "==BEGIN DUMP_ARRAYS==\n", v1, v1, v2);
    int64_t stream = *(int64_t *)*(int64_t *)190; // 0xbe
    ...
    if (n > 0) {
        int64_t v5 = n;
        int64_t v6 = 0;
        int64_t v7 = 0x1f40 * v6 + (0x100000000 * (int64_t)u >> 32);
        int64_t v8 = 0;
        int32_t v9 = (int32_t)v6 * n + (int32_t)v8; // 0x103
        int64_t v10 = (0x100000000 * (int64_t)(v9 >> 31) | (int64_t)v9) % 20; // 0x10c
        int64_t v11 = v10 & 0xffffffff; // 0x10c
        if ((int32_t)v10 == 0) {
            // 0x117
            int128_t v12; // 0x90
            fprintf(*(int64_t *)*(int64_t *)286, "\n", v11, 20, v12);
        }
        int128_t v13 = __asm_movsd(*(int64_t *)(v7 + 8 * v8)); // 0x14f
        fprintf(*(int64_t *)*(int64_t *)310, "%0.2lf ", v11, v8, v13);
        int64_t v14 = v8 + 1;
        int128_t v15 = v13; // 0xf6
        while (v14 != v5) {
            // 0xfc
            v8 = v14;
        ...
        while (v6 != v5) {
            // 0xfc
            v7 = 0x1f40 * v6 + (0x100000000 * (int64_t)u >> 32);
            v15 = v13;
            v8 = 0;
            v9 = (int32_t)v6 * n + (int32_t)v8;
            v10 = (0x100000000 * (int64_t)(v9 >> 31) | (int64_t)v9) % 20;
    ...
    int64_t stream2 = *(int64_t *)*(int64_t *)394; // 0x18a
    fprintf(stream2, "\nend   dump: %s\n", (int64_t)&g1, v3, v4);
    int64_t stream3 = *(int64_t *)*(int64_t *)425; // 0x1a9
    fprintf(stream3, "==END   DUMP_ARRAYS==\n", (int64_t)&g1, v3, v4);
}

// Address range: 0x1c0 - 0x9b0
// Line range:    67 - 128
void kernel_adi(int32_t tsteps, int32_t n, float64_t (*u)[1], float64_t (*v)[1], float64_t (*p)[1], float64_t (*q)[1]) {
...
// Address range: 0x9b0 - 0xa9e
// Line range:    131 - 167
int32_t submain(int32_t argc, char ** argv) {
    int64_t v1 = polybench_alloc_data(0xf4240, 8); // 0x9d7
    int64_t v2 = polybench_alloc_data(0xf4240, 8); // 0x9ea
    int64_t v3 = polybench_alloc_data(0xf4240, 8); // 0x9fd
    int64_t v4 = polybench_alloc_data(0xf4240, 8); // 0xa10
    kernel_adi(500, 1000, &((float64_t (*)[1][1])v1)[0], &((float64_t (*)[1][1])v2)[0], &((float64_t (*)[1][1])v3)[0], &((float64_t (*)[1][1])v4)[0]);
    if (argc < 43) {
        // 0xa72
    ...
    // 0xa4a
    if ((int32_t)strcmp(1000, 2826) == 0) {
        // 0xa66
        print_array(1000, &((float64_t (*)[1][1])v1)[0]);
    }
    // 0xa72
    free(&((float64_t (*)[1][1])v1)[0]);
    free(&((float64_t (*)[1][1])v2)[0]);
