...
int64_t function_1b0(int64_t a1, int64_t a2, int64_t a3, int64_t a4);
int64_t function_1fdf(int64_t a1);
...
int32_t * g1 = (int32_t *)-0x745fbad6f0ffffc7; // 0x38
int128_t g2; // 0x3a00
int128_t g3; // 0x3a10
int128_t g4; // 0x3a20
int128_t g5; // 0x3a30
...
// Address range: 0x1b0 - 0x284
int64_t function_1b0(int64_t a1, int64_t a2, int64_t a3, int64_t a4) {
    // 0x1b0
    int64_t v1; // 0x1b0
    int32_t * v2 = (int32_t *)(v1 - 20); // 0x1b2
    AddRoundKey((int32_t *)a1, *v2, 0);
    int32_t * v3 = (int32_t *)(v1 - 24); // 0x1bc
    *v3 = 1;
    int64_t * v4 = (int64_t *)(v1 - 8);
    int64_t v5 = *v4;
    int64_t v6 = v5; // 0x1d4
    if (*(int32_t *)*(int64_t *)461 != -9) {
        ByteSub_ShiftRow((int32_t *)v5, *(int32_t *)*(int64_t *)485);
        MixColumn_AddRoundKey((int32_t *)*v4, *(int32_t *)*(int64_t *)503, *v3);
        uint32_t v7 = *v3 + 1; // 0x204
        *v3 = v7;
        int64_t v8 = *v4;
        v6 = v8;
        while (v7 <= *(int32_t *)*(int64_t *)461 + 9) {
            // 0x1da
            ByteSub_ShiftRow((int32_t *)v8, *(int32_t *)*(int64_t *)485);
            MixColumn_AddRoundKey((int32_t *)*v4, *(int32_t *)*(int64_t *)503, *v3);
            v7 = *v3 + 1;
            *v3 = v7;
            v8 = *v4;
    ...
    // 0x20f
    ByteSub_ShiftRow((int32_t *)v6, *(int32_t *)*(int64_t *)538);
    AddRoundKey((int32_t *)*v4, *v2, *v3);
    *v3 = 0;
    int64_t v9 = 0; // 0x249
    int32_t v10 = *(int32_t *)(v9 + *v4); // 0x249
    int32_t v11 = *(int32_t *)(v1 - 96 + v9); // 0x250
    int32_t v12 = *(int32_t *)*(int64_t *)611; // 0x263
    *(int32_t *)*(int64_t *)620 = v12 + (int32_t)(v10 != v11);
    int32_t v13 = *v3 + 1; // 0x271
    *v3 = v13;
    while (v13 <= 15) {
        // 0x241
        v9 = 4 * (int64_t)v13;
...
// From module:   /docker_shared/cs699_webassembly/emscripten_compile/CHStone_v1.11_150204/aes/aes.c
// Address range: 0x290 - 0x6cd
// Line range:    77 - 163
int32_t KeySchedule(int32_t type, int32_t * key) {
    int32_t v1 = 4; // 0x290
    int32_t v2 = 4; // 0x290
...
// From module:   /docker_shared/cs699_webassembly/emscripten_compile/aes_key.c
// Address range: 0x6d0 - 0x895
// Line range:    512 - 541
int32_t AddRoundKey(int32_t * statemt, int32_t type, int32_t n) {
    int32_t v1 = 4; // 0x6d0
    int64_t v2; // 0x6d0
...
// From module:   /docker_shared/cs699_webassembly/emscripten_compile/aes_enc.c
// Address range: 0x1e10 - 0x1fdd
// Line range:    63 - 140
int32_t decrypt(int32_t * statemt, int32_t * key, int32_t type) {
    // 0x1e10
...
// Address range: 0x1fdf - 0x20b4
int64_t function_1fdf(int64_t a1) {
    // 0x1fdf
    int64_t v1; // 0x1fdf
    int32_t * v2 = (int32_t *)(v1 - 20); // 0x1fe1
    AddRoundKey((int32_t *)v1, *v2, *(int32_t *)*(int64_t *)0x1feb);
    int64_t * v3 = (int64_t *)(v1 - 8); // 0x1ff2
    InversShiftRow_ByteSub((int32_t *)*v3, *(int32_t *)*(int64_t *)0x1ffd);
    int32_t v4 = *(int32_t *)*(int64_t *)0x200b - 1; // 0x200d
    int32_t * v5 = (int32_t *)(v1 - 24); // 0x2010
    *v5 = v4;
    int64_t v6 = *v3;
    int64_t v7 = v6; // 0x2017
    if (v4 >= 1) {
        int32_t v8 = *(int32_t *)*(int64_t *)0x2028; // 0x2028
        AddRoundKey_InversMixColumn((int32_t *)v6, v8, v4);
        InversShiftRow_ByteSub((int32_t *)*v3, *(int32_t *)*(int64_t *)0x203d);
        int32_t v9 = *v5 - 1; // 0x2047
        *v5 = v9;
        int64_t v10 = *v3;
        v7 = v10;
        while (v9 >= 1) {
            // 0x201d
            v8 = *(int32_t *)*(int64_t *)0x2028;
            AddRoundKey_InversMixColumn((int32_t *)v10, v8, v9);
            InversShiftRow_ByteSub((int32_t *)*v3, *(int32_t *)*(int64_t *)0x203d);
            v9 = *v5 - 1;
            *v5 = v9;
            v10 = *v3;
    ...
    // 0x2052
    AddRoundKey((int32_t *)v7, *v2, 0);
    *v5 = 0;
    int64_t v11 = 0; // 0x2079
    int32_t v12 = *(int32_t *)(v11 + *v3); // 0x2079
    int32_t v13 = *(int32_t *)(v1 - 96 + v11); // 0x2080
    int32_t v14 = *(int32_t *)*(int64_t *)0x2093; // 0x2093
    *(int32_t *)*(int64_t *)0x209c = v14 + (int32_t)(v12 != v13);
    int32_t v15 = *v5 + 1; // 0x20a1
    *v5 = v15;
    while (v15 <= 15) {
        // 0x2071
        v11 = 4 * (int64_t)v15;
        v12 = *(int32_t *)(v11 + *v3);
        v13 = *(int32_t *)(v1 - 96 + v11);
        v14 = *(int32_t *)*(int64_t *)0x2093;
        *(int32_t *)*(int64_t *)0x209c = v14 + (int32_t)(v12 != v13);
        v15 = *v5 + 1;
        *v5 = v15;
    }
...
// Address range: 0x3930 - 0x3995
// Line range:    144 - 152
int32_t submain(void) {
    // 0x3930
    *(int32_t *)*(int64_t *)0x393b = 0;
    int64_t v1 = __asm_movsd((int128_t)(int32_t)(float32_t)rtclock()); // 0x394d
    *(int64_t *)*(int64_t *)0x394d = v1;
    aes_main();
    int64_t v2 = __asm_movsd((int128_t)(int32_t)(float32_t)rtclock()); // 0x3962
    *(int64_t *)*(int64_t *)0x3962 = v2;
    int128_t v3 = __asm_movsd_2(*(int64_t *)*(int64_t *)0x396d); // 0x396d
    int64_t v4; // 0x3930
    printf("%0.6f\n", v4, __asm_subsd(v3, *(int64_t *)*(int64_t *)0x3978));
    return *(int32_t *)*(int64_t *)0x3991;
}

// Address range: 0x39a0 - 0x39f4
// Line range:    127 - 134
float64_t rtclock(void) {
    // 0x39a0
    int64_t Tp; // bp-24, 0x39a0
    int64_t v1 = gettimeofday(&Tp, 0); // 0x39b0
    if ((int32_t)v1 != 0) {
        // 0x39c2
        int128_t v2; // 0x39a0
        printf("Error return from gettimeofday: %d", v1 & 0xffffffff, v2);
    }
    int128_t v3 = __asm_cvtsi2sd(Tp); // 0x39d3
    int64_t v4; // 0x39a0
    int128_t v5 = __asm_mulsd(__asm_cvtsi2sd_3((int32_t)v4), __asm_movsd_2(0x3eb0c6f7a0b5ed8d)); // 0x39e6
