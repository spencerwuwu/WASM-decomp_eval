...

{
  ...
  if (local_4c < 1) {
    if (local_4c < 0) {
      ...
      local_40 = uVar2;
      local_38 = uVar1;
      if (uVar2 < uVar1) goto LAB_00100aeb;
      if (uVar2 <= uVar1) {
...
void float64_ge(undefined8 param_1,undefined8 param_2)
...

{
  ...
  for (local_10 = 0; local_10 < 0x24; local_10 = local_10 + 1) {
    lVar1 = local_sin(*(undefined8 *)((long)local_10 * 8 + -0x1231737c374b8));
    local_c = (uint)(lVar1 != *(long *)((long)local_10 * 8 + 0x24c0950fd1043b48)) + local_c;
  }
  _DAT_58b4800110ff2 = rtclock();
  printf("%0.6f\n",_DAT_58b4800100ff2 - _DAT_8c3d8d48005c0ff2);
  return local_c;
}
