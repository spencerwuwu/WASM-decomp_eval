...
typedef pointer pointer __((offset(0xe70)));
...
typedef pointer pointer __((offset(0x1460)));

typedef pointer pointer __((offset(0x14b0)));

typedef pointer pointer __((offset(0x1600)));
