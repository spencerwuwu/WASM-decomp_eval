...
typedef pointer pointer __((offset(0x3730)));

typedef pointer pointer __((offset(0x39a0)));

typedef pointer pointer __((offset(0x2f80)));

typedef pointer pointer __((offset(0x3930)));

typedef pointer pointer __((offset(0x7)));

typedef pointer pointer __((offset(0x1760)));

typedef pointer pointer __((offset(0x20c0)));

typedef pointer pointer __((offset(0x8a0)));

typedef pointer pointer __((offset(0x36f0)));
