...

{
  ...
  for (local_14 = param_2; 0x3f < (int)local_14; local_14 = local_14 - 0x40) {
    local_memcpy(0xfe0de800000040ba,local_10,0x40);
    sha_transform();
    local_10 = local_10 + 0x40;
  }
  local_memcpy(0xc48348fffffddbe8,local_10,local_14);
  return;
}
...

{
  ...
  *(undefined4 *)((long)(int)uVar3 * 4 + -0x7cffffff7f77fb39) = 0x80;
  if (uVar4 < 0x39) {
    local_memset(0x8bfffffc9de8f631,0,0x38 - uVar4,uVar4);
  }
  else {
    local_memset(0xe8fffffcd5e8f631,0,0x40 - uVar4,uVar4);
    sha_transform();
    local_memset(0x8900000038bac931,0,0x38);
  }
  _DAT_8b48f84d8b3848c1 = uVar2;
  _DAT_12ee83c48c5 = uVar1;
  sha_transform();
  return;
}
...

{
  ...
  printf("%0.6f\n",_DAT_58b4800100ff2 - _DAT_863d8d48005c0ff2);
  return local_10;
}
