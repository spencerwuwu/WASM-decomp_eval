...
typedef pointer pointer __((offset(0xc27)));

typedef pointer pointer __((offset(0x43)));

typedef pointer pointer __((offset(0xcb0)));

typedef pointer pointer __((offset(0xb9c)));

typedef pointer pointer __((offset(0xc13)));
...
typedef pointer pointer __((offset(0xb07)));

typedef pointer pointer __((offset(0xc58)));

typedef pointer pointer __((offset(0x15d)));

typedef pointer pointer __((offset(0xc5f)));

typedef pointer pointer __((offset(0x5e)));

typedef pointer pointer __((offset(0x11d)));

typedef pointer pointer __((offset(0xa9f)));

typedef pointer pointer __((offset(0xc00)));

typedef pointer pointer __((offset(0xc73)));

typedef pointer pointer __((offset(0x1a0)));

typedef pointer pointer __((offset(0xa30)));
