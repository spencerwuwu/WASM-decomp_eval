...
typedef pointer pointer __((offset(0x1ad)));

typedef pointer pointer __((offset(0x157)));

typedef pointer pointer __((offset(0x216)));

typedef pointer pointer __((offset(0x61)));

typedef pointer pointer __((offset(0xcf)));
