...

{
  ...
  puVar4 = (undefined *)CONCAT44(in_register_0000003c,__fd);
...

{
  ...
  if (bVar4) {
    pbVar5 = (byte *)CONCAT17(uRam0007fcb900458b50,_DAT_7fcb900458b49);
    lVar12 = _DAT_d8b48218b4c;
    if (pbVar5 < (byte *)0x299830fc84144) {
      do {
        pbVar1 = pbVar5 + 1;
        _DAT_7fcb900458b49 = SUB87(pbVar1,0);
        uRam0007fcb900458b50 = (undefined)((ulong)pbVar1 >> 0x38);
    ...
    if (uVar8 < 0x20000000) {
      if (uVar8 < 0xc000000) {
        ...
        *piVar7 = iVar15;
        iVar10 = _DAT_800b9240c89098b;
        if (iVar15 < 0x19) {
          pbVar5 = (byte *)CONCAT71(_DAT_7fcb900458b49,DAT_7fcb900458b48);
          lVar12 = _DAT_d8b48218b4c;
          if (pbVar5 < (byte *)0x382830fc84144) {
            do {
              pbVar1 = pbVar5 + 1;
              DAT_7fcb900458b48 = SUB81(pbVar1,0);
              _DAT_7fcb900458b49 = (undefined7)((ulong)pbVar1 >> 8);
...
void motion_vectors(long param_1,undefined8 param_2,long param_3,int param_4,int param_5,
                   uint param_6,undefined4 param_7,undefined4 param_8,uint param_9,
                   undefined4 param_10)

{
  ...
  if (param_5 == 1) {
    ...
    *(undefined8 *)(param_1 + 0x10 + lVar5 * 8) = *(undefined8 *)(param_1 + lVar5 * 8);
  }
  else {
...
void motion_vector(int *param_1,undefined4 *param_2,int param_3,int param_4,int param_5,int param_6,
                  int param_7)

{
  ...
  if ((int)uVar3 < 1) {
    if (((int)uVar3 < 0) &&
       ...
       SBORROW4(iVar4,-iVar8) != iVar4 + iVar8 < 0)) {
      iVar8 = 0x20;
      goto LAB_00101642;
    }
  }
...
LAB_00101642:
  ...
  *param_1 = iVar4 << (param_7 != 0);
  ...
  if ((int)uVar3 < 1) {
    if ((-1 < (int)uVar3) ||
       (iVar4 = iVar4 + ~(uVar10 + (~uVar3 << (bVar7 & 0x1f))),
       SBORROW4(iVar4,-iVar8) == iVar4 + iVar8 < 0)) goto LAB_001017f6;
    iVar8 = 0x20;
  }
  else {
    iVar4 = iVar4 + (uVar3 - 1 << (bVar7 & 0x1f)) + uVar10 + 1;
...

{
  ...
  iVar3 = _DAT_31450c244489008b;
  _DAT_b80000000000c7 = 0;
  _DAT_58b4823894c = &DAT_1d8b48c40949;
  _DAT_2d8b4c20894c = &DAT_1d8b48c40949;
  _DAT_41000000045c741 = 0x4100000;
  local_38 = &DAT_1d8b48c40949;
  uVar4 = 0;
  do {
    uVar2 = _DAT_41000000045c741;
    if ((byte *)0x1d8b48c40948 < _DAT_58b4823894c) {
      memcpy(&DAT_e0894c102464894c,(void *)0x2b8948000025a0e8,0x800);
      if (iVar3 != 0) {
        _DAT_8894810244c8948 = local_38 + -0x800;
        local_38 = _DAT_8894810244c8948;
      }
      _DAT_58b4823894c = &DAT_e0894c102464894c;
    }
    bVar1 = *_DAT_58b4823894c;
    _DAT_58b4823894c = _DAT_58b4823894c + 1;
    _DAT_41000000045c741 = uVar2 | (uint)bVar1 << (0x18U - (char)uVar4 & 0x1f);
    bVar5 = uVar4 < 0x11;
    uVar4 = uVar4 + 8;
  } while (bVar5);
  _DAT_83480000002000c7 = 0x20;
  return;
}
...

{
  ...
  uVar1 = gettimeofday((timeval *)local_78,(__timezone_ptr_t)0x0);
  if (uVar1 != 0) {
    printf("Error return from gettimeofday: %d",(ulong)uVar1);
  }
  _DAT_58b4808110ff2 = (double)iStack_70 * 1e-06 + (double)CONCAT44(local_78._4_4_,local_78._0_4_);
  _DAT_8b480000000000c7 = 0;
  _DAT_c7480000000000c7 = 0;
  local_48 = 0;
  local_58[0] = _DAT_302444290f00280f;
  local_58[1] = uRam302444290f002813;
  local_58[2] = uRam302444290f002817;
  local_58[3] = uRam302444290f00281b;
  local_78._0_4_ = _DAT_f1048280f00280f;
  local_78._4_4_ = uRam0f1048280f002813;
  iStack_70 = uRam0f1048280f002817;
  uStack_6c = uRam0f1048280f00281b;
  local_68 = CONCAT44(uRam0f1048280f002823,_DAT_f1048280f00281f);
  uStack_60 = uRam0f1048280f002827;
  uStack_5c = uRam0f1048280f00282b;
  _DAT_b80000000000c7 = 0;
  _DAT_58b48006d8949 = &DAT_2d8b4cc50948;
  _DAT_358b4c288948 = &DAT_2d8b4cc50948;
  _DAT_410410000006c741 = 0x4100000;
  uVar1 = 0;
  do {
    uVar7 = _DAT_410410000006c741;
    pbVar2 = _DAT_58b48006d8949;
    if ((byte *)0x2d8b4cc50947 < _DAT_58b48006d8949) {
      memcpy(&DAT_10b60f25ebe88948,(void *)0x5d894900002422e8,0x800);
      pbVar2 = &DAT_10b60f25ebe88948;
    }
    _DAT_58b48006d8949 = pbVar2 + 1;
    uVar7 = uVar7 | (uint)*pbVar2 << (0x18U - (char)uVar1 & 0x1f);
    bVar8 = uVar1 < 0x11;
    uVar1 = uVar1 + 8;
    _DAT_410410000006c741 = uVar7;
  } while (bVar8);
  _DAT_410410000006c741 = uVar7 * 2;
  _DAT_c1410000001f00c7 = 0x1f;
  local_58[0] = uVar7 >> 0x1f;
  local_58[2] = local_58[0];
  motion_vector(local_78,&local_48,200,200,0,1,0);
  local_68 = CONCAT44(local_78._4_4_,local_78._0_4_);
  iVar4 = 0;
  lVar6 = 0;
  do {
    lVar3 = 0;
    do {
      iVar4 = iVar4 + (uint)(local_58[lVar6 * 2 + lVar3] !=
                            *(uint *)(&DAT_31000000000d8b48 + lVar3 * 4 + lVar6 * 8));
      lVar5 = 0;
      do {
        iVar4 = iVar4 + (uint)(*(int *)(local_78 + lVar5 * 4 + lVar3 * 8 + lVar6 * 0x10) !=
                              *(int *)(&DAT_666666d23190db31 + lVar5 * 4 + lVar3 * 8 + lVar6 * 0x10)
                              );
        bVar8 = lVar5 == 0;
        lVar5 = lVar5 + 1;
      } while (bVar8);
  ...
  _DAT_58b4800110ff2 = (double)local_40._8_4_ * 1e-06 + (double)local_40._0_8_;
  printf("%0.6f\n",SUB84(_DAT_58b4800110ff2 - _DAT_fe3d8d48005c0ff2,0));
  return iVar4;
}
