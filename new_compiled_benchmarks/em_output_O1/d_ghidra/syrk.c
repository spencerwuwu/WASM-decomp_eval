...

{
  ...
  do {
    ...
    do {
      *(double *)((long)__ptr_00 + lVar3 * 8 + lVar1 * 8000) =
           (double)(((int)lVar3 * (int)lVar1 + 1U) % 0x4b0) / 1200.0;
      lVar3 = lVar3 + 1;
    } while (lVar3 != 1000);
    lVar1 = lVar1 + 1;
  } while (lVar1 != 0x4b0);
  ...
  do {
    ...
    do {
      *(double *)((long)__ptr + lVar3 * 8 + lVar2 * 0x2580) =
           (double)(((int)lVar3 * (int)lVar2 + 2U) % 1000) / 1000.0;
      lVar3 = lVar3 + 1;
    } while (lVar3 != 0x4b0);
    lVar2 = lVar2 + 1;
  } while (lVar2 != 0x4b0);
  ...
  do {
    ...
    do {
      lVar4 = 0;
      do {
        *(double *)((long)__ptr + lVar4 * 8 + lVar1 * 0x2580) =
             *(double *)((long)__ptr_00 + lVar3 * 8 + lVar1 * 8000) * 1.5 *
             *(double *)((long)__ptr_00 + lVar3 * 8 + lVar4 * 8000) +
             *(double *)((long)__ptr + lVar4 * 8 + lVar1 * 0x2580);
        __stream = _DAT_f73d8d48388b4c;
        lVar4 = lVar4 + 1;
      } while (lVar4 != lVar2);
      lVar3 = lVar3 + 1;
    } while (lVar3 != 1000);
  ...
  if ((0x2a < param_1) && (**param_2 == '\0')) {
    fwrite(_L_str_1,0x16,1,_DAT_f73d8d48388b4c);
    lVar1 = 0;
