...

{
  ...
  _DAT_4802e0c1480163a0 = CONCAT44(uRam4802e0c14801639c,_DAT_4802e0c148016398);
...

{
  ...
  *(undefined4 *)((long)param_2 + 0x14) = *(undefined4 *)(param_2 + 2);
  *(undefined8 *)((long)param_2 + 0xc) = param_2[1];
  *(undefined8 *)((long)param_2 + 4) = *param_2;
  *(int *)param_2 = param_1;
  return;
}
...

{
  ...
  puRam0000000000101127 = &DAT_8b480000002000c7;
  return;
}
...

{
  ...
  lVar4 = 0;
  uVar1 = gettimeofday((timeval *)local_28,(__timezone_ptr_t)0x0);
  if (uVar1 != 0) {
    printf("Error return from gettimeofday: %d",(ulong)uVar1);
  }
  _DAT_fc8de80e110f41f2 = (double)local_28._8_4_ * 1e-06 + (double)local_28._0_8_;
  adpcm_main();
  lVar2 = 0;
  iVar3 = 0;
  do {
    iVar3 = iVar3 + (uint)(*(int *)(&DAT_31000000000d8b48 + lVar2 * 4) !=
                          *(int *)(&DAT_f2e6666db31d231 + lVar2 * 4));
    lVar2 = lVar2 + 1;
  } while (lVar2 != 0x32);
  do {
    iVar3 = iVar3 + (uint)(*(int *)(&DAT_66000000000d8b48 + lVar4 * 4) !=
                          *(int *)(&DAT_841f0f2e6666 + lVar4 * 4));
    lVar4 = lVar4 + 1;
  } while (lVar4 != 100);
  uVar1 = gettimeofday((timeval *)local_28,(__timezone_ptr_t)0x0);
  if (uVar1 != 0) {
  ...
  _DAT_5c0f41f200110ff2 = (double)local_28._8_4_ * 1e-06 + (double)local_28._0_8_;
  printf("%0.6f\n",_DAT_5c0f41f200110ff2 - _DAT_fc8de80e110f41f2);
  return iVar3;
}
