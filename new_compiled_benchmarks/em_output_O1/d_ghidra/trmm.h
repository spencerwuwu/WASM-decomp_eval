...
typedef pointer pointer __((offset(0x2e7)));

typedef pointer pointer __((offset(0xd0)));

typedef pointer pointer __((offset(0x325)));

typedef pointer pointer __((offset(0x28)));

typedef pointer pointer __((offset(0x26)));

typedef pointer pointer __((offset(0x2ce)));

typedef pointer pointer __((offset(0x37c)));

typedef pointer pointer __((offset(0x122)));

typedef pointer pointer __((offset(0x101)));
