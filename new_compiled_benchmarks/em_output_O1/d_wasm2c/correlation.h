...
typedef struct w2c_correlation {
...
void wasm2c_correlation_instantiate(w2c_correlation*, struct w2c_GOT0x2Emem*, struct w2c_env*);
void wasm2c_correlation_free(w2c_correlation*);
...
extern const u32 wasm2c_correlation_min_env_memory;
extern const u32 wasm2c_correlation_max_env_memory;

/* export: '__wasm_call_ctors' */
void w2c_correlation_0x5F_wasm_call_ctors(w2c_correlation*);
