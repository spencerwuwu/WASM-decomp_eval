...
void wasm2c_trisolv_instantiate(w2c_trisolv*, struct w2c_GOT0x2Emem*, struct w2c_env*);
void wasm2c_trisolv_free(w2c_trisolv*);
...
extern const u32 wasm2c_trisolv_min_env_memory;
extern const u32 wasm2c_trisolv_max_env_memory;

/* export: '__wasm_call_ctors' */
void w2c_trisolv_0x5F_wasm_call_ctors(w2c_trisolv*);

/* export: '__wasm_apply_data_relocs' */
void w2c_trisolv_0x5F_wasm_apply_data_relocs(w2c_trisolv*);

/* export: 'kernel_trisolv' */
void w2c_trisolv_kernel_trisolv(w2c_trisolv*, u32, u32, u32, u32);

/* export: 'submain' */
u32 w2c_trisolv_submain(w2c_trisolv*, u32, u32);
