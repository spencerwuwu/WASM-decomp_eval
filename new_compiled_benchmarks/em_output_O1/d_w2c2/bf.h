...
U32 env__memcpy(struct bfInstance*,U32,U32,U32);

U32 env__gettimeofday(struct bfInstance*,U32,U32);

U32 env__iprintf(struct bfInstance*,U32,U32);

U32 env_____small_printf(struct bfInstance*,U32,U32);

void f4(bfInstance*);

void f5(bfInstance*);

void f6(bfInstance*,U32,U32,U32);

void f7(bfInstance*,U32,U32);

void f8(bfInstance*,U32,U32);

void f9(bfInstance*,U32,U32,U32,U32,U32,U32);
