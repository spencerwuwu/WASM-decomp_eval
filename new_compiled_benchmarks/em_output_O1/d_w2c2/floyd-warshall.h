...
U32 env__fwrite(struct floydwarshallInstance*,U32,U32,U32,U32);

U32 env__fiprintf(struct floydwarshallInstance*,U32,U32,U32);

U32 env__fputc(struct floydwarshallInstance*,U32,U32);
