...
LAB_001003b2:
  ...
  do {
    lVar14 = 0;
    do {
      *(int *)(&DAT_841f0f2e666666 + uVar6 * 4 + lVar14 * 0x1e0) =
           *(int *)(param_2 + (lVar14 + uVar6 * 4) * 4);
      lVar14 = lVar14 + 1;
    } while (lVar14 != 4);
    uVar6 = uVar6 + 1;
  } while (uVar6 != uVar13);
  ...
  do {
    ...
    if (iVar10 == 0) {
      ...
      local_38[1] = *(int *)(uVar6 * 4 + 0x841f0f2e666842);
      local_38[2] = *(int *)(uVar6 * 4 + 0x841f0f2e666a22);
      puVar7 = (int *)((uVar6 - 1) * 4 + 0x841f0f2e666c06);
    }
    local_38[3] = *puVar7;
    if (!(int)(iVar10 != 4 | bVar5 ^ 1)) {
      lVar14 = 0;
      do {
