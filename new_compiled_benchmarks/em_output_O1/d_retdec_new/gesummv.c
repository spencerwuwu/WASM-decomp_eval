...
int64_t kernel_gesummv(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6) {
    ...
    *v3 = __asm_movsd_1(__asm_addsd(__asm_mulsd(v8, *v9), *v3));
    int128_t v10 = __asm_mulsd(__asm_movsd(*(int64_t *)(v7 + a3)), *v9); // 0x5a
    int64_t v11 = __asm_movsd_1(__asm_addsd(v10, *v4)); // 0x66
    *v4 = v11;
    v5++;
    while (v5 != result2) {
        // 0x30
        ...
        v9 = (int64_t *)(v6 + a5);
        *v3 = __asm_movsd_1(__asm_addsd(__asm_mulsd(v8, *v9), *v3));
        v10 = __asm_mulsd(__asm_movsd(*(int64_t *)(v7 + a3)), *v9);
        v11 = __asm_movsd_1(__asm_addsd(v10, *v4));
        *v4 = v11;
        v5++;
    }
    // 0x74
    int128_t v12; // 0x0
    int128_t v13 = __asm_mulsd_2(__asm_movsd(v11), v12); // 0x7a
    *v4 = __asm_movsd_1(__asm_addsd_3(__asm_mulsd_2(__asm_movsd(*v3), v12), v13));
    v1++;
    while (v1 != result2) {
        // 0x10
        v2 = 8 * v1;
        ...
        *v4 = v11;
        ...
        // 0x74
        v13 = __asm_mulsd_2(__asm_movsd(v11), v12);
        *v4 = __asm_movsd_1(__asm_addsd_3(__asm_mulsd_2(__asm_movsd(*v3), v12), v13));
        v1++;
    }
    // 0x9d
