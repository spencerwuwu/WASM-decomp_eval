            ...
            else
            {
                if (!(((unsigned short)(a1 >> 52) & 2047) == 2047))
                {
                    ...
                    *((char *)&v17) = v3 == 0;
                    ...
                    v20 = ((v3 != 0? a0 << 9 & 0x1ffffffffffffe00 | 0x2000000000000000 : a0 << 9 & 0x1ffffffffffffe00) | 0x2000000000000000) + rdx<8>;
                    v21 = 0;
                    *((char *)&v21) = [D] amd64g_calculate_condition(0x9<64>, 0x4<64>, r11<8>, r11<8>, cc_ndep<8>);
                    *((unsigned int *)&v8) = ((char)[D] amd64g_calculate_condition(0x8<64>, 0x4<64>, r11<8>, r11<8>, cc_ndep<8>)? v20 : v20 << 1);
                    v22 = v4 - v21;
    ...
    else
    {
        ...
        else
        {
            ...
            else if (!(((unsigned short)(a1 >> 52) & 2047) == 2047))
            {
                v23 = 0;
                *((char *)&v23) = v3 == 0;
                v24 = (v3 == 0? a0 << 10 & 0x3ffffffffffffc00 : a0 << 10 & 0x3ffffffffffffc00 | 0x4000000000000000);
                v26 = v5 + v23;
                if (!((unsigned int)(v5 + v23) == 0))
                {
                    if ((unsigned int)v26 >= -63)
                    {
                        v33 = (v3 == 0? a0 << 10 & 0x3ffffffffffffc00 : a0 << 10 & 0x3ffffffffffffc00 | 0x4000000000000000) >> ((char)(0 - (unsigned int)v26) & 63);
                        v34 = 0;
                        *((char *)&v34) = (v3 == 0? v12 : v12 | 0x4000000000000000) << ((char)v26 & 63) != 0;
                        v32 = v34 | v33;
                    }
                    else
                    {
                        v32 = 0;
                        *((char *)&v32) = (v3 == 0? a0 << 10 & 0x3ffffffffffffc00 : a0 << 10 & 0x3ffffffffffffc00 | 0x4000000000000000) != 0;
                    }
                    v24 = v32;
                }
...
long long submain(unsigned long a0, unsigned long a1, unsigned short a2)
{
    ...
    *((unsigned long long *)got.startTimer) = v8;
    ...
    while (true)
    {
        v10 = float64_add(*((long long *)(got.a_input + (v12 << 3))), *((long long *)(got.b_input + (v12 << 3))), a2) != *((long long *)(got.z_output + (v12 << 3)));
        v3 += rcx<8>;
        v12 += 1;
        if (v12 == 46)
        {
