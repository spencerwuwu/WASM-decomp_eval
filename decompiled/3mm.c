...

{
  ...
  pvVar2 = (void *)_polybench_alloc_data(0x8598);
  pvVar3 = (void *)_polybench_alloc_data(36000,8);
  pvVar4 = (void *)_polybench_alloc_data(38000,8);
  pvVar5 = (void *)_polybench_alloc_data(0x9bdc,8);
  pvVar6 = (void *)_polybench_alloc_data(0xa348,8);
  pvVar7 = (void *)_polybench_alloc_data(0xb478,8);
  pvVar8 = (void *)_polybench_alloc_data(0x93a8,8);
  _init_array(0xb4,0xbe,200,0xd2,0xdc,pvVar3,pvVar4,pvVar6,pvVar7);
  _polybench_timer_start();
  _kernel_3mm(0xb4,0xbe,200,0xd2,0xdc,pvVar2,pvVar3,pvVar4,pvVar5,pvVar6,pvVar7,pvVar8);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < param_1) && (iVar1 = __stubs::_strcmp(*param_2,""), iVar1 == 0)) {
    _print_array(0xb4,0xd2,pvVar8);
  }
...
void _init_array(int param_1,int param_2,int param_3,int param_4,int param_5,long param_6,
...

{
  ...
  for (local_3c = 0; local_3c < param_1; local_3c = local_3c + 1) {
    for (local_40 = 0; local_40 < param_3; local_40 = local_40 + 1) {
      iVar1 = local_3c * local_40 + 1;
      iVar2 = 0;
      if (param_1 != 0) {
        iVar2 = iVar1 / param_1;
      }
      *(double *)(param_6 + (long)local_3c * 0x640 + (long)local_40 * 8) =
           (double)(iVar1 - iVar2 * param_1) / (double)(param_1 * 5);
    }
  }
  for (local_3c = 0; local_3c < param_3; local_3c = local_3c + 1) {
    for (local_40 = 0; local_40 < param_2; local_40 = local_40 + 1) {
      iVar1 = local_3c * (local_40 + 1) + 2;
      iVar2 = 0;
      if (param_2 != 0) {
        iVar2 = iVar1 / param_2;
      }
      *(double *)(param_7 + (long)local_3c * 0x5f0 + (long)local_40 * 8) =
           (double)(iVar1 - iVar2 * param_2) / (double)(param_2 * 5);
    }
  }
  for (local_3c = 0; local_3c < param_2; local_3c = local_3c + 1) {
    for (local_40 = 0; local_40 < param_5; local_40 = local_40 + 1) {
      iVar1 = local_3c * (local_40 + 3);
      iVar2 = 0;
      if (param_4 != 0) {
        iVar2 = iVar1 / param_4;
      }
      *(double *)(param_8 + (long)local_3c * 0x6e0 + (long)local_40 * 8) =
           (double)(iVar1 - iVar2 * param_4) / (double)(param_4 * 5);
    }
  }
  for (local_3c = 0; local_3c < param_5; local_3c = local_3c + 1) {
    for (local_40 = 0; local_40 < param_4; local_40 = local_40 + 1) {
      iVar1 = local_3c * (local_40 + 2) + 2;
      iVar2 = 0;
      if (param_3 != 0) {
        iVar2 = iVar1 / param_3;
      }
      *(double *)(param_9 + (long)local_3c * 0x690 + (long)local_40 * 8) =
           (double)(iVar1 - iVar2 * param_3) / (double)(param_3 * 5);
    }
  }
  return;
}
...
void _kernel_3mm(int param_1,int param_2,int param_3,int param_4,int param_5,long param_6,
...

{
  ...
  for (local_54 = 0; local_54 < param_1; local_54 = local_54 + 1) {
    for (local_58 = 0; local_58 < param_2; local_58 = local_58 + 1) {
      *(undefined8 *)(param_6 + (long)local_54 * 0x5f0 + (long)local_58 * 8) = 0;
      for (local_5c = 0; local_5c < param_3; local_5c = local_5c + 1) {
        pdVar1 = (double *)(param_6 + (long)local_54 * 0x5f0 + (long)local_58 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_7 + (long)local_54 * 0x640 + (long)local_5c * 8) *
                            *(double *)(param_8 + (long)local_5c * 0x5f0 + (long)local_58 * 8);
      }
    }
  }
  for (local_54 = 0; local_54 < param_2; local_54 = local_54 + 1) {
    for (local_58 = 0; local_58 < param_4; local_58 = local_58 + 1) {
      *(undefined8 *)(param_9 + (long)local_54 * 0x690 + (long)local_58 * 8) = 0;
      for (local_5c = 0; local_5c < param_5; local_5c = local_5c + 1) {
        pdVar1 = (double *)(param_9 + (long)local_54 * 0x690 + (long)local_58 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_10 + (long)local_54 * 0x6e0 + (long)local_5c * 8) *
                            *(double *)(param_11 + (long)local_5c * 0x690 + (long)local_58 * 8);
      }
    }
  }
  for (local_54 = 0; local_54 < param_1; local_54 = local_54 + 1) {
    for (local_58 = 0; local_58 < param_4; local_58 = local_58 + 1) {
      *(undefined8 *)(param_12 + (long)local_54 * 0x690 + (long)local_58 * 8) = 0;
      for (local_5c = 0; local_5c < param_2; local_5c = local_5c + 1) {
        pdVar1 = (double *)(param_12 + (long)local_54 * 0x690 + (long)local_58 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_6 + (long)local_54 * 0x5f0 + (long)local_5c * 8) *
                            *(double *)(param_9 + (long)local_5c * 0x690 + (long)local_58 * 8);
      }
    }
  }
  return;
