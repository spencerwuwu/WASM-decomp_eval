...

{
  ...
  _kernel_seidel_2d(100,400,pvVar2);
...

{
  ...
  for (local_14 = 0; local_14 < param_1; local_14 = local_14 + 1) {
    for (local_18 = 0; local_18 < param_1; local_18 = local_18 + 1) {
      *(double *)(param_2 + (long)local_14 * 0xc80 + (long)local_18 * 8) =
           ((double)(long)local_14 * (double)(local_18 + 2) + 2.0) / (double)(long)param_1;
    }
  }
  return;
}
...
void _kernel_seidel_2d(int param_1,int param_2,long param_3)

{
  ...
  for (local_14 = 0; local_14 <= param_1 + -1; local_14 = local_14 + 1) {
    for (local_18 = 1; local_18 <= param_2 + -2; local_18 = local_18 + 1) {
      for (local_1c = 1; local_1c <= param_2 + -2; local_1c = local_1c + 1) {
        *(double *)(param_3 + (long)local_18 * 0xc80 + (long)local_1c * 8) =
             (*(double *)(param_3 + (long)(local_18 + -1) * 0xc80 + (long)(local_1c + -1) * 8) +
              *(double *)(param_3 + (long)(local_18 + -1) * 0xc80 + (long)local_1c * 8) +
              *(double *)(param_3 + (long)(local_18 + -1) * 0xc80 + (long)(local_1c + 1) * 8) +
              *(double *)(param_3 + (long)local_18 * 0xc80 + (long)(local_1c + -1) * 8) +
              *(double *)(param_3 + (long)local_18 * 0xc80 + (long)local_1c * 8) +
              *(double *)(param_3 + (long)local_18 * 0xc80 + (long)(local_1c + 1) * 8) +
              *(double *)(param_3 + (long)(local_18 + 1) * 0xc80 + (long)(local_1c + -1) * 8) +
              *(double *)(param_3 + (long)(local_18 + 1) * 0xc80 + (long)local_1c * 8) +
             *(double *)(param_3 + (long)(local_18 + 1) * 0xc80 + (long)(local_1c + 1) * 8)) / 9.0;
      }
    }
  }
  return;
