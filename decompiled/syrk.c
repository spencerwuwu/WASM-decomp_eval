...

{
  ...
  _init_array(local_24,local_28,&local_30,&local_38,pvVar2,pvVar3);
  _polybench_timer_start();
  _kernel_syrk(local_30,local_38,local_24,local_28,pvVar2,pvVar3);
  ...
  *param_4 = 0x3ff3333333333333;
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    for (local_30 = 0; local_30 < param_2; local_30 = local_30 + 1) {
      ...
      *(double *)(param_6 + (long)local_2c * 0x640 + (long)local_30 * 8) =
           (double)(iVar1 - iVar2 * param_1) / (double)(long)param_1;
    }
  }
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    for (local_30 = 0; local_30 < param_1; local_30 = local_30 + 1) {
      iVar1 = local_2c * local_30 + 2;
      iVar2 = 0;
      if (param_2 != 0) {
        iVar2 = iVar1 / param_2;
      }
      *(double *)(param_5 + (long)local_2c * 0x780 + (long)local_30 * 8) =
...
void _kernel_syrk(double param_1,double param_2,int param_3,int param_4,long param_5,long param_6)
    ...
    for (local_34 = 0; local_34 < param_4; local_34 = local_34 + 1) {
      for (local_30 = 0; local_30 <= local_2c; local_30 = local_30 + 1) {
        ...
        *pdVar1 = *pdVar1 + param_1 * *(double *)
                                       (param_6 + (long)local_2c * 0x640 + (long)local_34 * 8) *
