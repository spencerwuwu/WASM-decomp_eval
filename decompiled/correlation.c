...

{
  ...
  local_20 = param_2;
  local_14 = param_1;
  pvVar2 = (void *)_polybench_alloc_data(0xf3c0);
  pvVar3 = (void *)_polybench_alloc_data(0xe100,8);
  pvVar4 = (void *)_polybench_alloc_data(0xf0,8);
  pvVar5 = (void *)_polybench_alloc_data(0xf0,8);
  _init_array(local_28,local_24,&local_30,pvVar2);
  _polybench_timer_start();
  _kernel_correlation(local_30,local_28,local_24,pvVar2,pvVar3,pvVar4,pvVar5);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < local_14) && (iVar1 = __stubs::_strcmp(*local_20,""), iVar1 == 0)) {
    _print_array(local_28,pvVar3);
  }
...
void _init_array(undefined8 param_1,undefined8 param_2,undefined8 *param_3,long param_4)

{
  int local_20;
  int local_1c;
  
  *param_3 = 0x4070400000000000;
  for (local_1c = 0; local_1c < 0x104; local_1c = local_1c + 1) {
    for (local_20 = 0; local_20 < 0xf0; local_20 = local_20 + 1) {
      *(double *)(param_4 + (long)local_1c * 0x780 + (long)local_20 * 8) =
           (double)(local_1c * local_20) / 240.0 + (double)(long)local_1c;
    }
  }
  return;
}
...
void _kernel_correlation(double param_1,int param_2,int param_3,long param_4,long param_5,
  ...
  for (local_38 = 0; local_38 < param_2; local_38 = local_38 + 1) {
    *(undefined8 *)(param_6 + (long)local_38 * 8) = 0;
    for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
      pdVar1 = (double *)(param_6 + (long)local_38 * 8);
      *pdVar1 = *pdVar1 + *(double *)(param_4 + (long)local_34 * 0x780 + (long)local_38 * 8);
    }
    pdVar1 = (double *)(param_6 + (long)local_38 * 8);
    *pdVar1 = *pdVar1 / param_1;
  }
  for (local_38 = 0; local_38 < param_2; local_38 = local_38 + 1) {
    *(undefined8 *)(param_7 + (long)local_38 * 8) = 0;
    for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
      pdVar1 = (double *)(param_7 + (long)local_38 * 8);
      *pdVar1 = *pdVar1 + (*(double *)(param_4 + (long)local_34 * 0x780 + (long)local_38 * 8) -
    ...
    pdVar1 = (double *)(param_7 + (long)local_38 * 8);
    *pdVar1 = *pdVar1 / param_1;
    *(double *)(param_7 + (long)local_38 * 8) = SQRT(*(double *)(param_7 + (long)local_38 * 8));
    if (0.1 < *(double *)(param_7 + (long)local_38 * 8)) {
      local_50 = *(undefined8 *)(param_7 + (long)local_38 * 8);
    }
    else {
      local_50 = 0x3ff0000000000000;
    }
    *(undefined8 *)(param_7 + (long)local_38 * 8) = local_50;
  }
  for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
    for (local_38 = 0; local_38 < param_2; local_38 = local_38 + 1) {
      pdVar1 = (double *)(param_4 + (long)local_34 * 0x780 + (long)local_38 * 8);
      *pdVar1 = *pdVar1 - *(double *)(param_6 + (long)local_38 * 8);
      pdVar1 = (double *)(param_4 + (long)local_34 * 0x780 + (long)local_38 * 8);
      *pdVar1 = *pdVar1 / (SQRT(param_1) * *(double *)(param_7 + (long)local_38 * 8));
    }
  }
  for (local_34 = 0; local_34 < param_2 + -1; local_34 = local_34 + 1) {
    *(undefined8 *)(param_5 + (long)local_34 * 0x780 + (long)local_34 * 8) = 0x3ff0000000000000;
    local_38 = local_34;
    while (local_38 = local_38 + 1, local_38 < param_2) {
      *(undefined8 *)(param_5 + (long)local_34 * 0x780 + (long)local_38 * 8) = 0;
      for (local_3c = 0; local_3c < param_3; local_3c = local_3c + 1) {
        pdVar1 = (double *)(param_5 + (long)local_34 * 0x780 + (long)local_38 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_4 + (long)local_3c * 0x780 + (long)local_34 * 8) *
                            *(double *)(param_4 + (long)local_3c * 0x780 + (long)local_38 * 8);
      }
      *(undefined8 *)(param_5 + (long)local_38 * 0x780 + (long)local_34 * 8) =
           *(undefined8 *)(param_5 + (long)local_34 * 0x780 + (long)local_38 * 8);
    }
  }
  *(undefined8 *)(param_5 + (long)(param_2 + -1) * 0x780 + (long)(param_2 + -1) * 8) =
       0x3ff0000000000000;
  return;
}
