...

{
  ...
  pvVar2 = (void *)_polybench_alloc_data(500,1);
  pvVar3 = (void *)_polybench_alloc_data(250000,4);
  _init_array(500,pvVar2,pvVar3);
  _polybench_timer_start();
  _kernel_nussinov(500,pvVar2,pvVar3);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < param_1) && (iVar1 = __stubs::_strcmp(*param_2,""), iVar1 == 0)) {
    _print_array(500,pvVar3);
  }
...
void _init_array(int param_1,long param_2,long param_3)

{
  ...
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    *(char *)(param_2 + local_1c) = (char)(local_1c + 1) + (char)((local_1c + 1) / 4) * -4;
  }
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    for (local_20 = 0; local_20 < param_1; local_20 = local_20 + 1) {
      *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) = 0;
    }
  }
  return;
}
...
void _kernel_nussinov(int param_1,long param_2,long param_3)

{
  ...
  for (local_1c = param_1 + -1; iVar1 = local_1c, -1 < local_1c; local_1c = local_1c + -1) {
    while (local_20 = iVar1 + 1, local_20 < param_1) {
      if (-1 < iVar1) {
        if (*(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) <
            *(int *)(param_3 + (long)local_1c * 2000 + (long)iVar1 * 4)) {
          local_28 = *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)iVar1 * 4);
        }
        else {
          local_28 = *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4);
        }
        *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) = local_28;
      }
      if (local_1c + 1 < param_1) {
        if (*(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) <
            *(int *)(param_3 + (long)(local_1c + 1) * 2000 + (long)local_20 * 4)) {
          local_2c = *(undefined4 *)(param_3 + (long)(local_1c + 1) * 2000 + (long)local_20 * 4);
        }
        else {
          local_2c = *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4);
        }
        *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) = local_2c;
      }
      iVar2 = local_1c;
      if ((-1 < iVar1) && (local_1c + 1 < param_1)) {
        if (local_1c < iVar1) {
          if (*(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) <
              (int)(*(int *)(param_3 + (long)(local_1c + 1) * 2000 + (long)iVar1 * 4) +
                   (uint)((int)*(char *)(param_2 + local_1c) + (int)*(char *)(param_2 + local_20) ==
                         3))) {
            local_30 = *(int *)(param_3 + (long)(local_1c + 1) * 2000 + (long)iVar1 * 4) +
                       (uint)((int)*(char *)(param_2 + local_1c) +
                              (int)*(char *)(param_2 + local_20) == 3);
          }
          else {
            local_30 = *(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4);
          }
          *(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) = local_30;
        }
        else {
          if (*(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) <
              *(int *)(param_3 + (long)(local_1c + 1) * 2000 + (long)iVar1 * 4)) {
            local_34 = *(undefined4 *)(param_3 + (long)(local_1c + 1) * 2000 + (long)iVar1 * 4);
          }
          else {
            local_34 = *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4);
          }
          *(undefined4 *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) = local_34;
        }
      }
      while (local_24 = iVar2 + 1, iVar1 = local_20, local_24 < local_20) {
        if (*(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) <
            *(int *)(param_3 + (long)local_1c * 2000 + (long)local_24 * 4) +
            *(int *)(param_3 + (long)(iVar2 + 2) * 2000 + (long)local_20 * 4)) {
          local_38 = *(int *)(param_3 + (long)local_1c * 2000 + (long)local_24 * 4) +
                     *(int *)(param_3 + (long)(iVar2 + 2) * 2000 + (long)local_20 * 4);
        }
        else {
          local_38 = *(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4);
        }
        *(int *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 4) = local_38;
        iVar2 = local_24;
      }
    }
  }
...

{
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    for (local_28 = local_24; local_28 < param_1; local_28 = local_28 + 1) {
      if (local_2c % 0x14 == 0) {
