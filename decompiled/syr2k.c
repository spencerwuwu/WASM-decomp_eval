...

{
  ...
  local_20 = param_2;
  local_14 = param_1;
  pvVar2 = (void *)_polybench_alloc_data(0xe100);
  ...
  _kernel_syr2k(local_30,local_38,local_24,local_28,pvVar2,pvVar3,pvVar4);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < local_14) && (iVar1 = __stubs::_strcmp(*local_20,""), iVar1 == 0)) {
    _print_array(local_24,pvVar2);
  }
...
void _kernel_syr2k(double param_1,double param_2,int param_3,int param_4,long param_5,long param_6,
                  long param_7)

{
  ...
  for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
    ...
    for (local_3c = 0; local_3c < param_4; local_3c = local_3c + 1) {
      for (local_38 = 0; local_38 <= local_34; local_38 = local_38 + 1) {
        pdVar1 = (double *)(param_5 + (long)local_34 * 0x780 + (long)local_38 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_6 + (long)local_38 * 0x640 + (long)local_3c * 8) *
                            param_1 * *(double *)
                                       (param_7 + (long)local_34 * 0x640 + (long)local_3c * 8) +
                            *(double *)(param_7 + (long)local_38 * 0x640 + (long)local_3c * 8) *
                            param_1 * *(double *)
                                       (param_6 + (long)local_34 * 0x640 + (long)local_3c * 8);
      }
    }
  }
  return;
