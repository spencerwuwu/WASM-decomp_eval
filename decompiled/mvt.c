...

{
  ...
  _init_array(400,pvVar3,pvVar4,pvVar5,pvVar6,pvVar2);
  _polybench_timer_start();
  _kernel_mvt(400,pvVar3,pvVar4,pvVar5,pvVar6,pvVar2);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < param_1) && (iVar1 = __stubs::_strcmp(*param_2,""), iVar1 == 0)) {
    _print_array(400,pvVar3,pvVar4);
  }
...
void _init_array(int param_1,long param_2,long param_3,long param_4,long param_5,long param_6)

{
  ...
  for (local_34 = 0; local_34 < param_1; local_34 = local_34 + 1) {
    ...
    *(double *)(param_2 + (long)local_34 * 8) =
    ...
    iVar1 = 0;
    if (param_1 != 0) {
      iVar1 = (local_34 + 1) / param_1;
    }
    *(double *)(param_3 + (long)local_34 * 8) =
         (double)((local_34 + 1) - iVar1 * param_1) / (double)(long)param_1;
    iVar1 = 0;
    if (param_1 != 0) {
      iVar1 = (local_34 + 3) / param_1;
    }
    *(double *)(param_4 + (long)local_34 * 8) =
         (double)((local_34 + 3) - iVar1 * param_1) / (double)(long)param_1;
    iVar1 = 0;
    if (param_1 != 0) {
      iVar1 = (local_34 + 4) / param_1;
    }
    *(double *)(param_5 + (long)local_34 * 8) =
         (double)((local_34 + 4) - iVar1 * param_1) / (double)(long)param_1;
    for (local_38 = 0; local_38 < param_1; local_38 = local_38 + 1) {
      iVar1 = 0;
      if (param_1 != 0) {
        iVar1 = (local_34 * local_38) / param_1;
      }
      *(double *)(param_6 + (long)local_34 * 0xc80 + (long)local_38 * 8) =
           (double)(local_34 * local_38 - iVar1 * param_1) / (double)(long)param_1;
    }
  }
  return;
}
...
void _kernel_mvt(int param_1,long param_2,long param_3,long param_4,long param_5,long param_6)

{
  ...
  for (local_34 = 0; local_34 < param_1; local_34 = local_34 + 1) {
    for (local_38 = 0; local_38 < param_1; local_38 = local_38 + 1) {
      *(double *)(param_3 + (long)local_34 * 8) =
           *(double *)(param_3 + (long)local_34 * 8) +
           *(double *)(param_6 + (long)local_38 * 0xc80 + (long)local_34 * 8) *
