...

{
  ...
  uVar3 = _polybench_alloc_data(64000,8);
  _init_array(0x28,pvVar2,uVar3);
  _polybench_timer_start();
  _kernel_heat_3d(100,0x28,pvVar2,uVar3);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < param_1) && (iVar1 = __stubs::_strcmp(*param_2,""), iVar1 == 0)) {
    _print_array(0x28,pvVar2);
  }
  ...
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    for (local_20 = 0; local_20 < param_1; local_20 = local_20 + 1) {
      for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
        dVar1 = ((double)(local_1c + local_20 + (param_1 - local_24)) * 10.0) /
                (double)(long)param_1;
        *(double *)(param_3 + (long)local_1c * 0x3200 + (long)local_20 * 0x140 + (long)local_24 * 8)
             = dVar1;
        *(double *)(param_2 + (long)local_1c * 0x3200 + (long)local_20 * 0x140 + (long)local_24 * 8)
             = dVar1;
      }
    }
  }
...
void _kernel_heat_3d(undefined8 param_1,int param_2,long param_3,long param_4)

{
  ...
  for (local_1c = 1; local_1c < 0x65; local_1c = local_1c + 1) {
    for (local_20 = 1; local_20 < param_2 + -1; local_20 = local_20 + 1) {
      for (local_24 = 1; local_24 < param_2 + -1; local_24 = local_24 + 1) {
        for (local_28 = 1; local_28 < param_2 + -1; local_28 = local_28 + 1) {
          *(double *)
           (param_4 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) =
               ((*(double *)
                  (param_3 + (long)(local_20 + 1) * 0x3200 + (long)local_24 * 0x140 +
                  (long)local_28 * 8) -
                *(double *)
                 (param_3 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) *
                2.0) + *(double *)
                        (param_3 + (long)(local_20 + -1) * 0x3200 + (long)local_24 * 0x140 +
                        (long)local_28 * 8)) * 0.125 +
               ((*(double *)
                  (param_3 + (long)local_20 * 0x3200 + (long)(local_24 + 1) * 0x140 +
                  (long)local_28 * 8) -
                *(double *)
                 (param_3 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) *
                2.0) + *(double *)
                        ...
                        (long)local_28 * 8)) * 0.125 +
               ((*(double *)
                  (param_3 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 +
                  (long)(local_28 + 1) * 8) -
                *(double *)
                 (param_3 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) *
                2.0) + *(double *)
                        (param_3 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 +
                        (long)(local_28 + -1) * 8)) * 0.125 +
               *(double *)
                (param_3 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8);
        }
      }
      ...
      for (local_24 = 1; local_24 < param_2 + -1; local_24 = local_24 + 1) {
        for (local_28 = 1; local_28 < param_2 + -1; local_28 = local_28 + 1) {
          *(double *)
           (param_3 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) =
               ((*(double *)
                  (param_4 + (long)(local_20 + 1) * 0x3200 + (long)local_24 * 0x140 +
                  (long)local_28 * 8) -
                *(double *)
                 (param_4 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) *
                2.0) + *(double *)
                        ...
                        (long)local_28 * 8)) * 0.125 +
               ((*(double *)
                  (param_4 + (long)local_20 * 0x3200 + (long)(local_24 + 1) * 0x140 +
                  (long)local_28 * 8) -
                *(double *)
                 (param_4 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) *
                2.0) + *(double *)
                        ...
                        (long)local_28 * 8)) * 0.125 +
               ((*(double *)
                  (param_4 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 +
                  (long)(local_28 + 1) * 8) -
                *(double *)
                 (param_4 + (long)local_20 * 0x3200 + (long)local_24 * 0x140 + (long)local_28 * 8) *
                2.0) + *(double *)
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    for (local_28 = 0; local_28 < param_1; local_28 = local_28 + 1) {
      for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
        if ((local_24 * param_1 * param_1 + local_28 * param_1 + local_2c) % 0x14 == 0) {
