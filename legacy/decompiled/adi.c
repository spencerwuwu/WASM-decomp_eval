...

{
  ...
  pvVar3 = (void *)_polybench_alloc_data(40000,8);
  pvVar4 = (void *)_polybench_alloc_data(40000,8);
  pvVar5 = (void *)_polybench_alloc_data(40000,8);
  _init_array(200,pvVar2);
  _polybench_timer_start();
  _kernel_adi(100,200,pvVar2,pvVar3,pvVar4,pvVar5);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < param_1) && (iVar1 = __stubs::_strcmp(*param_2,""), iVar1 == 0)) {
    _print_array(200,pvVar2);
  }
...

{
  ...
  for (local_14 = 0; local_14 < param_1; local_14 = local_14 + 1) {
    for (local_18 = 0; local_18 < param_1; local_18 = local_18 + 1) {
      *(double *)(param_2 + (long)local_14 * 0x640 + (long)local_18 * 8) =
           (double)((local_14 + param_1) - local_18) / (double)(long)param_1;
    }
  }
  return;
}
...
void _kernel_adi(int param_1,int param_2,long param_3,long param_4,long param_5,long param_6)

{
  ...
  dVar1 = ((1.0 / (double)(long)param_1) * 2.0) /
          ((1.0 / (double)(long)param_2) * (1.0 / (double)(long)param_2));
  dVar2 = ((1.0 / (double)(long)param_1) * 1.0) /
          ((1.0 / (double)(long)param_2) * (1.0 / (double)(long)param_2));
  dVar3 = -dVar1 / 2.0;
  dVar1 = dVar1 + 1.0;
  dVar4 = -dVar2 / 2.0;
  ...
  for (local_2c = 1; local_2c <= param_1; local_2c = local_2c + 1) {
    for (local_30 = 1; local_30 < param_2 + -1; local_30 = local_30 + 1) {
      *(undefined8 *)(param_4 + (long)local_30 * 8) = 0x3ff0000000000000;
      *(undefined8 *)(param_5 + (long)local_30 * 0x640) = 0;
      *(undefined8 *)(param_6 + (long)local_30 * 0x640) =
           *(undefined8 *)(param_4 + (long)local_30 * 8);
      for (local_34 = 1; local_34 < param_2 + -1; local_34 = local_34 + 1) {
        *(double *)(param_5 + (long)local_30 * 0x640 + (long)local_34 * 8) =
             -dVar3 / (dVar3 * *(double *)
                                (param_5 + (long)local_30 * 0x640 + (long)(local_34 + -1) * 8) +
                      dVar1);
        *(double *)(param_6 + (long)local_30 * 0x640 + (long)local_34 * 8) =
             (((-dVar4 * *(double *)(param_3 + (long)local_34 * 0x640 + (long)(local_30 + -1) * 8) +
               (dVar4 * 2.0 + 1.0) *
               *(double *)(param_3 + (long)local_34 * 0x640 + (long)local_30 * 8)) -
              dVar4 * *(double *)(param_3 + (long)local_34 * 0x640 + (long)(local_30 + 1) * 8)) -
             dVar3 * *(double *)(param_6 + (long)local_30 * 0x640 + (long)(local_34 + -1) * 8)) /
             (dVar3 * *(double *)(param_5 + (long)local_30 * 0x640 + (long)(local_34 + -1) * 8) +
             dVar1);
      }
      *(undefined8 *)(param_4 + (long)(param_2 + -1) * 0x640 + (long)local_30 * 8) =
           0x3ff0000000000000;
      for (local_34 = param_2 + -2; 0 < local_34; local_34 = local_34 + -1) {
        *(double *)(param_4 + (long)local_34 * 0x640 + (long)local_30 * 8) =
             *(double *)(param_5 + (long)local_30 * 0x640 + (long)local_34 * 8) *
             *(double *)(param_4 + (long)(local_34 + 1) * 0x640 + (long)local_30 * 8) +
             *(double *)(param_6 + (long)local_30 * 0x640 + (long)local_34 * 8);
      }
    }
    for (local_30 = 1; local_30 < param_2 + -1; local_30 = local_30 + 1) {
      *(undefined8 *)(param_3 + (long)local_30 * 0x640) = 0x3ff0000000000000;
      *(undefined8 *)(param_5 + (long)local_30 * 0x640) = 0;
      *(undefined8 *)(param_6 + (long)local_30 * 0x640) =
           *(undefined8 *)(param_3 + (long)local_30 * 0x640);
      for (local_34 = 1; local_34 < param_2 + -1; local_34 = local_34 + 1) {
        *(double *)(param_5 + (long)local_30 * 0x640 + (long)local_34 * 8) =
             -dVar4 / (dVar4 * *(double *)
                                (param_5 + (long)local_30 * 0x640 + (long)(local_34 + -1) * 8) +
                      dVar2);
        *(double *)(param_6 + (long)local_30 * 0x640 + (long)local_34 * 8) =
             (((-dVar3 * *(double *)(param_4 + (long)(local_30 + -1) * 0x640 + (long)local_34 * 8) +
               (dVar3 * 2.0 + 1.0) *
               *(double *)(param_4 + (long)local_30 * 0x640 + (long)local_34 * 8)) -
              dVar3 * *(double *)(param_4 + (long)(local_30 + 1) * 0x640 + (long)local_34 * 8)) -
             dVar4 * *(double *)(param_6 + (long)local_30 * 0x640 + (long)(local_34 + -1) * 8)) /
             (dVar4 * *(double *)(param_5 + (long)local_30 * 0x640 + (long)(local_34 + -1) * 8) +
             dVar2);
      }
      *(undefined8 *)(param_3 + (long)local_30 * 0x640 + (long)(param_2 + -1) * 8) =
           0x3ff0000000000000;
      for (local_34 = param_2 + -2; 0 < local_34; local_34 = local_34 + -1) {
        *(double *)(param_3 + (long)local_30 * 0x640 + (long)local_34 * 8) =
             *(double *)(param_5 + (long)local_30 * 0x640 + (long)local_34 * 8) *
             *(double *)(param_3 + (long)local_30 * 0x640 + (long)(local_34 + 1) * 8) +
             *(double *)(param_6 + (long)local_30 * 0x640 + (long)local_34 * 8);
      }
    }
  }
