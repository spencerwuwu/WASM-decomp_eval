...
void _init_array(int param_1,int param_2,long param_3,long param_4)

{
  ...
  for (local_1c = 0; local_1c < param_2; local_1c = local_1c + 1) {
    *(double *)(param_4 + (long)local_1c * 8) = (double)(long)local_1c / (double)(long)param_2 + 1.0
    ;
  }
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    for (local_20 = 0; local_20 < param_2; local_20 = local_20 + 1) {
      iVar1 = 0;
      if (param_2 != 0) {
        iVar1 = (local_1c + local_20) / param_2;
      }
      *(double *)(param_3 + (long)local_1c * 0xcd0 + (long)local_20 * 8) =
           (double)((local_1c + local_20) - iVar1 * param_2) / (double)(param_1 * 5);
    }
  }
  return;
}
...
void _kernel_atax(int param_1,int param_2,long param_3,long param_4,long param_5,long param_6)

{
  ...
  for (local_2c = 0; local_2c < param_2; local_2c = local_2c + 1) {
    *(undefined8 *)(param_5 + (long)local_2c * 8) = 0;
  }
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    *(undefined8 *)(param_6 + (long)local_2c * 8) = 0;
    for (local_30 = 0; local_30 < param_2; local_30 = local_30 + 1) {
      *(double *)(param_6 + (long)local_2c * 8) =
           *(double *)(param_6 + (long)local_2c * 8) +
           *(double *)(param_3 + (long)local_2c * 0xcd0 + (long)local_30 * 8) *
