...

{
  ...
  local_20 = param_2;
  local_14 = param_1;
  pvVar2 = (void *)_polybench_alloc_data(40000);
  pvVar3 = (void *)_polybench_alloc_data(48000,8);
  _init_array(local_24,local_28,&local_30,pvVar2,pvVar3);
  _polybench_timer_start();
  _kernel_trmm(local_30,local_24,local_28,pvVar2,pvVar3);
...
void _init_array(int param_1,int param_2,undefined8 *param_3,long param_4,long param_5)
  ...
  *param_3 = 0x3ff8000000000000;
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    for (local_28 = 0; local_28 < local_24; local_28 = local_28 + 1) {
      ...
      *(double *)(param_4 + (long)local_24 * 0x640 + (long)local_28 * 8) =
           (double)((local_24 + local_28) - iVar1 * param_1) / (double)(long)param_1;
    }
    *(undefined8 *)(param_4 + (long)local_24 * 0x640 + (long)local_24 * 8) = 0x3ff0000000000000;
    for (local_28 = 0; local_28 < param_2; local_28 = local_28 + 1) {
      iVar1 = param_2 + (local_24 - local_28);
      iVar2 = 0;
      if (param_2 != 0) {
        iVar2 = iVar1 / param_2;
      }
      *(double *)(param_5 + (long)local_24 * 0x780 + (long)local_28 * 8) =
...
void _kernel_trmm(double param_1,int param_2,int param_3,long param_4,long param_5)

{
  ...
  for (local_24 = 0; local_24 < param_2; local_24 = local_24 + 1) {
    for (local_28 = 0; local_2c = local_24, local_28 < param_3; local_28 = local_28 + 1) {
      while (local_2c = local_2c + 1, local_2c < param_2) {
        pdVar1 = (double *)(param_5 + (long)local_24 * 0x780 + (long)local_28 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_4 + (long)local_2c * 0x640 + (long)local_24 * 8) *
                            *(double *)(param_5 + (long)local_2c * 0x780 + (long)local_28 * 8);
      }
      *(double *)(param_5 + (long)local_24 * 0x780 + (long)local_28 * 8) =
           param_1 * *(double *)(param_5 + (long)local_24 * 0x780 + (long)local_28 * 8);
    }
  }
  return;
}
