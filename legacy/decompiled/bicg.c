...

{
  ...
  pvVar2 = (void *)_polybench_alloc_data(0x2709c);
  pvVar3 = (void *)_polybench_alloc_data(0x186,8);
  pvVar4 = (void *)_polybench_alloc_data(0x19a,8);
  pvVar5 = (void *)_polybench_alloc_data(0x186,8);
  pvVar6 = (void *)_polybench_alloc_data(0x19a,8);
  _init_array(0x186,0x19a,pvVar2,pvVar6,pvVar5);
  _polybench_timer_start();
  _kernel_bicg(0x186,0x19a,pvVar2,pvVar3,pvVar4,pvVar5,pvVar6);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < param_1) && (iVar1 = __stubs::_strcmp(*param_2,""), iVar1 == 0)) {
    _print_array(0x186,0x19a,pvVar3,pvVar4);
  }
...

{
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    iVar1 = 0;
    if (param_1 != 0) {
      iVar1 = local_24 / param_1;
    }
    *(double *)(param_5 + (long)local_24 * 8) =
         (double)(local_24 - iVar1 * param_1) / (double)(long)param_1;
  }
  for (local_24 = 0; local_24 < param_2; local_24 = local_24 + 1) {
    iVar1 = 0;
    if (param_2 != 0) {
      iVar1 = local_24 / param_2;
    }
    *(double *)(param_4 + (long)local_24 * 8) =
         (double)(local_24 - iVar1 * param_2) / (double)(long)param_2;
    for (local_28 = 0; local_28 < param_1; local_28 = local_28 + 1) {
      iVar1 = local_24 * (local_28 + 1);
      iVar2 = 0;
      if (param_2 != 0) {
        iVar2 = iVar1 / param_2;
      }
      *(double *)(param_3 + (long)local_24 * 0xc30 + (long)local_28 * 8) =
...
void _kernel_bicg(int param_1,int param_2,long param_3,long param_4,long param_5,long param_6,
                 long param_7)
    ...
    *(undefined8 *)(param_5 + (long)local_34 * 8) = 0;
    for (local_38 = 0; local_38 < param_1; local_38 = local_38 + 1) {
      *(double *)(param_4 + (long)local_38 * 8) =
           ...
           *(double *)(param_3 + (long)local_34 * 0xc30 + (long)local_38 * 8);
