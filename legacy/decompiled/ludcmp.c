...
void _init_array(int param_1,long param_2,long param_3,long param_4,long param_5)

{
  ...
  for (local_3c = 0; local_3c < param_1; local_3c = local_3c + 1) {
    *(undefined8 *)(param_4 + (long)local_3c * 8) = 0;
    *(undefined8 *)(param_5 + (long)local_3c * 8) = 0;
    *(double *)(param_3 + (long)local_3c * 8) =
         ((double)(local_3c + 1) / (double)(long)param_1) / 2.0 + 4.0;
  }
  for (local_3c = 0; local_3c < param_1; local_3c = local_3c + 1) {
    for (local_40 = 0; iVar2 = local_3c, local_40 <= local_3c; local_40 = local_40 + 1) {
      iVar2 = 0;
      if (param_1 != 0) {
        iVar2 = -local_40 / param_1;
      }
      *(double *)(param_2 + (long)local_3c * 0xc80 + (long)local_40 * 8) =
           (double)(-local_40 - iVar2 * param_1) / (double)(long)param_1 + 1.0;
    }
    while (local_40 = iVar2 + 1, local_40 < param_1) {
      *(undefined8 *)(param_2 + (long)local_3c * 0xc80 + (long)local_40 * 8) = 0;
      iVar2 = local_40;
    }
    *(undefined8 *)(param_2 + (long)local_3c * 0xc80 + (long)local_3c * 8) = 0x3ff0000000000000;
  }
  pvVar3 = (void *)_polybench_alloc_data(160000,8);
  for (local_4c = 0; local_4c < param_1; local_4c = local_4c + 1) {
    for (local_50 = 0; local_50 < param_1; local_50 = local_50 + 1) {
      *(undefined8 *)((long)pvVar3 + (long)local_50 * 8 + (long)local_4c * 0xc80) = 0;
    }
  }
  for (local_54 = 0; local_54 < param_1; local_54 = local_54 + 1) {
    for (local_4c = 0; local_4c < param_1; local_4c = local_4c + 1) {
      for (local_50 = 0; local_50 < param_1; local_50 = local_50 + 1) {
        pdVar1 = (double *)((long)pvVar3 + (long)local_50 * 8 + (long)local_4c * 0xc80);
        *pdVar1 = *pdVar1 + *(double *)(param_2 + (long)local_4c * 0xc80 + (long)local_54 * 8) *
                            *(double *)(param_2 + (long)local_50 * 0xc80 + (long)local_54 * 8);
      }
    }
  }
  for (local_4c = 0; local_4c < param_1; local_4c = local_4c + 1) {
    for (local_50 = 0; local_50 < param_1; local_50 = local_50 + 1) {
      *(undefined8 *)(param_2 + (long)local_4c * 0xc80 + (long)local_50 * 8) =
           *(undefined8 *)((long)pvVar3 + (long)local_50 * 8 + (long)local_4c * 0xc80);
    }
  }
  __stubs::_free(pvVar3);
  return;
...
void _kernel_ludcmp(int param_1,long param_2,long param_3,long param_4,long param_5)

{
  ...
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    for (local_30 = 0; local_30 < local_2c; local_30 = local_30 + 1) {
      local_40 = *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_30 * 8);
      for (local_34 = 0; local_34 < local_30; local_34 = local_34 + 1) {
        local_40 = local_40 -
                   *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_34 * 8) *
                   *(double *)(param_2 + (long)local_34 * 0xc80 + (long)local_30 * 8);
      }
      *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_30 * 8) =
           local_40 / *(double *)(param_2 + (long)local_30 * 0xc80 + (long)local_30 * 8);
    }
    for (local_30 = local_2c; local_30 < param_1; local_30 = local_30 + 1) {
      local_40 = *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_30 * 8);
      ...
      *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_30 * 8) = local_40;
    }
  }
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    local_40 = *(double *)(param_3 + (long)local_2c * 8);
    for (local_30 = 0; local_30 < local_2c; local_30 = local_30 + 1) {
      local_40 = local_40 -
                 *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_30 * 8) *
                 *(double *)(param_5 + (long)local_30 * 8);
    }
    *(double *)(param_5 + (long)local_2c * 8) = local_40;
  }
  for (local_2c = param_1 + -1; -1 < local_2c; local_2c = local_2c + -1) {
    local_40 = *(double *)(param_5 + (long)local_2c * 8);
    local_30 = local_2c;
    while (local_30 = local_30 + 1, local_30 < param_1) {
      local_40 = local_40 -
                 *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_30 * 8) *
                 *(double *)(param_4 + (long)local_30 * 8);
    }
    *(double *)(param_4 + (long)local_2c * 8) =
         local_40 / *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_2c * 8);
  }
  return;
}
