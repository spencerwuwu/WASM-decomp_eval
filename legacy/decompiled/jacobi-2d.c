...

{
  ...
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    for (local_20 = 0; local_20 < param_1; local_20 = local_20 + 1) {
      *(double *)(param_2 + (long)local_1c * 2000 + (long)local_20 * 8) =
           ((double)(long)local_1c * (double)(local_20 + 2) + 2.0) / (double)(long)param_1;
      *(double *)(param_3 + (long)local_1c * 2000 + (long)local_20 * 8) =
           ((double)(long)local_1c * (double)(local_20 + 3) + 3.0) / (double)(long)param_1;
    }
  }
  return;
}
...
void _kernel_jacobi_2d(int param_1,int param_2,long param_3,long param_4)
  ...
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    for (local_20 = 1; local_20 < param_2 + -1; local_20 = local_20 + 1) {
      for (local_24 = 1; local_24 < param_2 + -1; local_24 = local_24 + 1) {
        *(double *)(param_4 + (long)local_20 * 2000 + (long)local_24 * 8) =
             (*(double *)(param_3 + (long)local_20 * 2000 + (long)local_24 * 8) +
              *(double *)(param_3 + (long)local_20 * 2000 + (long)(local_24 + -1) * 8) +
              *(double *)(param_3 + (long)local_20 * 2000 + (long)(local_24 + 1) * 8) +
              *(double *)(param_3 + (long)(local_20 + 1) * 2000 + (long)local_24 * 8) +
             *(double *)(param_3 + (long)(local_20 + -1) * 2000 + (long)local_24 * 8)) * 0.2;
      }
    }
    for (local_20 = 1; local_20 < param_2 + -1; local_20 = local_20 + 1) {
      for (local_24 = 1; local_24 < param_2 + -1; local_24 = local_24 + 1) {
        *(double *)(param_3 + (long)local_20 * 2000 + (long)local_24 * 8) =
             (*(double *)(param_4 + (long)local_20 * 2000 + (long)local_24 * 8) +
              *(double *)(param_4 + (long)local_20 * 2000 + (long)(local_24 + -1) * 8) +
              *(double *)(param_4 + (long)local_20 * 2000 + (long)(local_24 + 1) * 8) +
              *(double *)(param_4 + (long)(local_20 + 1) * 2000 + (long)local_24 * 8) +
             *(double *)(param_4 + (long)(local_20 + -1) * 2000 + (long)local_24 * 8)) * 0.2;
      }
    }
  }
  return;
