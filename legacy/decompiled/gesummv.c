...

{
  ...
  pvVar3 = (void *)_polybench_alloc_data(0xf424,8);
  pvVar4 = (void *)_polybench_alloc_data(0xfa,8);
  pvVar5 = (void *)_polybench_alloc_data(0xfa,8);
  pvVar6 = (void *)_polybench_alloc_data(0xfa,8);
  _init_array(local_24,&local_30,&local_38,pvVar2,pvVar3,pvVar5);
  _polybench_timer_start();
  _kernel_gesummv(local_30,local_38,local_24,pvVar2,pvVar3,pvVar4,pvVar5,pvVar6);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < local_14) && (iVar1 = __stubs::_strcmp(*local_20,""), iVar1 == 0)) {
    _print_array(local_24,pvVar6);
  }
...

{
  ...
  *param_3 = 0x3ff3333333333333;
  for (local_34 = 0; local_34 < param_1; local_34 = local_34 + 1) {
    iVar1 = 0;
    if (param_1 != 0) {
      iVar1 = local_34 / param_1;
    }
    *(double *)(param_6 + (long)local_34 * 8) =
         (double)(local_34 - iVar1 * param_1) / (double)(long)param_1;
    for (local_38 = 0; local_38 < param_1; local_38 = local_38 + 1) {
      iVar1 = local_34 * local_38 + 1;
      iVar2 = 0;
      if (param_1 != 0) {
        iVar2 = iVar1 / param_1;
      }
      *(double *)(param_4 + (long)local_34 * 2000 + (long)local_38 * 8) =
           (double)(iVar1 - iVar2 * param_1) / (double)(long)param_1;
      iVar1 = local_34 * local_38 + 2;
      iVar2 = 0;
      if (param_1 != 0) {
        iVar2 = iVar1 / param_1;
      }
      *(double *)(param_5 + (long)local_34 * 2000 + (long)local_38 * 8) =
           (double)(iVar1 - iVar2 * param_1) / (double)(long)param_1;
    }
  }
  return;
...
void _kernel_gesummv(double param_1,double param_2,int param_3,long param_4,long param_5,
...

{
  ...
  for (local_44 = 0; local_44 < param_3; local_44 = local_44 + 1) {
    *(undefined8 *)(param_6 + (long)local_44 * 8) = 0;
    *(undefined8 *)(param_8 + (long)local_44 * 8) = 0;
    for (local_48 = 0; local_48 < param_3; local_48 = local_48 + 1) {
      *(double *)(param_6 + (long)local_44 * 8) =
           *(double *)(param_4 + (long)local_44 * 2000 + (long)local_48 * 8) *
           *(double *)(param_7 + (long)local_48 * 8) + *(double *)(param_6 + (long)local_44 * 8);
      *(double *)(param_8 + (long)local_44 * 8) =
           *(double *)(param_5 + (long)local_44 * 2000 + (long)local_48 * 8) *
           *(double *)(param_7 + (long)local_48 * 8) + *(double *)(param_8 + (long)local_44 * 8);
    }
    *(double *)(param_8 + (long)local_44 * 8) =
         param_1 * *(double *)(param_6 + (long)local_44 * 8) +
         param_2 * *(double *)(param_8 + (long)local_44 * 8);
  }
  return;
}
