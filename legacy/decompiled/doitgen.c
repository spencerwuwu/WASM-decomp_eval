...
void _kernel_doitgen(int param_1,int param_2,int param_3,long param_4,long param_5,long param_6)
      ...
      for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
        *(undefined8 *)(param_6 + (long)local_34 * 8) = 0;
        for (local_38 = 0; local_38 < param_3; local_38 = local_38 + 1) {
          pdVar1 = (double *)(param_6 + (long)local_34 * 8);
          *pdVar1 = *pdVar1 + *(double *)
                               (param_4 + (long)local_2c * 0x4b00 + (long)local_30 * 0x1e0 +
                               (long)local_38 * 8) *
                              *(double *)(param_5 + (long)local_38 * 0x1e0 + (long)local_34 * 8);
        }
      }
      for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
        *(undefined8 *)
         (param_4 + (long)local_2c * 0x4b00 + (long)local_30 * 0x1e0 + (long)local_34 * 8) =
             *(undefined8 *)(param_6 + (long)local_34 * 8);
      }
    }
  }
  return;
...

{
  ...
  pvVar2 = (void *)_polybench_alloc_data(120000);
  pvVar3 = (void *)_polybench_alloc_data(0x3c,8);
  pvVar4 = (void *)_polybench_alloc_data(0xe10,8);
  _init_array(0x32,0x28,0x3c,pvVar2,pvVar4);
  _polybench_timer_start();
  _kernel_doitgen(0x32,0x28,0x3c,pvVar2,pvVar4,pvVar3);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < param_1) && (iVar1 = __stubs::_strcmp(*param_2,""), iVar1 == 0)) {
    _print_array(0x32,0x28,0x3c,pvVar2);
  }
...
void _init_array(int param_1,int param_2,int param_3,long param_4,long param_5)

{
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    for (local_28 = 0; local_28 < param_2; local_28 = local_28 + 1) {
      for (local_2c = 0; local_2c < param_3; local_2c = local_2c + 1) {
        iVar1 = local_24 * local_28 + local_2c;
        iVar2 = 0;
        if (param_3 != 0) {
          iVar2 = iVar1 / param_3;
        }
        *(double *)(param_4 + (long)local_24 * 0x4b00 + (long)local_28 * 0x1e0 + (long)local_2c * 8)
  ...
  for (local_24 = 0; local_24 < param_3; local_24 = local_24 + 1) {
    for (local_28 = 0; local_28 < param_3; local_28 = local_28 + 1) {
      iVar1 = 0;
      if (param_3 != 0) {
        iVar1 = (local_24 * local_28) / param_3;
      }
      *(double *)(param_5 + (long)local_24 * 0x1e0 + (long)local_28 * 8) =
           (double)(local_24 * local_28 - iVar1 * param_3) / (double)(long)param_3;
    }
  }
  return;
}
...
int _print_array(int param_1,int param_2,int param_3)

{
  ...
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    for (local_30 = 0; local_30 < param_2; local_30 = local_30 + 1) {
      for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
        if ((local_2c * param_2 * param_3 + local_30 * param_3 + local_34) % 0x14 == 0) {
