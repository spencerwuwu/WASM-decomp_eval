...

{
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    for (local_28 = 0; iVar2 = local_24, local_28 <= local_24; local_28 = local_28 + 1) {
      iVar2 = 0;
      if (param_1 != 0) {
        iVar2 = -local_28 / param_1;
      }
      *(double *)(param_2 + (long)local_24 * 0xc80 + (long)local_28 * 8) =
           (double)(-local_28 - iVar2 * param_1) / (double)(long)param_1 + 1.0;
    }
    while (local_28 = iVar2 + 1, local_28 < param_1) {
      *(undefined8 *)(param_2 + (long)local_24 * 0xc80 + (long)local_28 * 8) = 0;
      iVar2 = local_28;
    }
    *(undefined8 *)(param_2 + (long)local_24 * 0xc80 + (long)local_24 * 8) = 0x3ff0000000000000;
  }
  ...
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    for (local_30 = 0; local_30 < param_1; local_30 = local_30 + 1) {
      *(undefined8 *)((long)pvVar3 + (long)local_30 * 8 + (long)local_2c * 0xc80) = 0;
    }
  }
  for (local_34 = 0; local_34 < param_1; local_34 = local_34 + 1) {
    for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
      for (local_30 = 0; local_30 < param_1; local_30 = local_30 + 1) {
        pdVar1 = (double *)((long)pvVar3 + (long)local_30 * 8 + (long)local_2c * 0xc80);
        *pdVar1 = *pdVar1 + *(double *)(param_2 + (long)local_2c * 0xc80 + (long)local_34 * 8) *
                            *(double *)(param_2 + (long)local_30 * 0xc80 + (long)local_34 * 8);
      }
    }
  }
  for (local_2c = 0; local_2c < param_1; local_2c = local_2c + 1) {
    for (local_30 = 0; local_30 < param_1; local_30 = local_30 + 1) {
      *(undefined8 *)(param_2 + (long)local_2c * 0xc80 + (long)local_30 * 8) =
           *(undefined8 *)((long)pvVar3 + (long)local_30 * 8 + (long)local_2c * 0xc80);
    }
  }
...
void _kernel_cholesky(int param_1,long param_2)
  ...
  for (local_14 = 0; local_14 < param_1; local_14 = local_14 + 1) {
    for (local_18 = 0; local_18 < local_14; local_18 = local_18 + 1) {
      for (local_1c = 0; local_1c < local_18; local_1c = local_1c + 1) {
        pdVar1 = (double *)(param_2 + (long)local_14 * 0xc80 + (long)local_18 * 8);
        *pdVar1 = *pdVar1 - *(double *)(param_2 + (long)local_14 * 0xc80 + (long)local_1c * 8) *
                            *(double *)(param_2 + (long)local_18 * 0xc80 + (long)local_1c * 8);
      }
      pdVar1 = (double *)(param_2 + (long)local_14 * 0xc80 + (long)local_18 * 8);
      *pdVar1 = *pdVar1 / *(double *)(param_2 + (long)local_18 * 0xc80 + (long)local_18 * 8);
    }
    for (local_1c = 0; local_1c < local_14; local_1c = local_1c + 1) {
      pdVar1 = (double *)(param_2 + (long)local_14 * 0xc80 + (long)local_14 * 8);
      *pdVar1 = *pdVar1 - *(double *)(param_2 + (long)local_14 * 0xc80 + (long)local_1c * 8) *
                          *(double *)(param_2 + (long)local_14 * 0xc80 + (long)local_1c * 8);
    }
    *(double *)(param_2 + (long)local_14 * 0xc80 + (long)local_14 * 8) =
         SQRT(*(double *)(param_2 + (long)local_14 * 0xc80 + (long)local_14 * 8));
  }
  return;
}
