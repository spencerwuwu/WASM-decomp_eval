...

{
  ...
  _init_array(400,pvVar2,pvVar3,pvVar4);
  _polybench_timer_start();
  _kernel_trisolv(400,pvVar2,pvVar3,pvVar4);
...
void _init_array(int param_1,long param_2,long param_3,long param_4)

{
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    *(undefined8 *)(param_3 + (long)local_24 * 8) = 0xc08f380000000000;
    *(double *)(param_4 + (long)local_24 * 8) = (double)(long)local_24;
    for (local_28 = 0; local_28 <= local_24; local_28 = local_28 + 1) {
      *(double *)(param_2 + (long)local_24 * 0xc80 + (long)local_28 * 8) =
           ((double)(((local_24 + param_1) - local_28) + 1) * 2.0) / (double)(long)param_1;
    }
  }
  return;
}
...
void _kernel_trisolv(int param_1,long param_2,long param_3,long param_4)

{
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    *(undefined8 *)(param_3 + (long)local_24 * 8) = *(undefined8 *)(param_4 + (long)local_24 * 8);
    for (local_28 = 0; local_28 < local_24; local_28 = local_28 + 1) {
      pdVar1 = (double *)(param_3 + (long)local_24 * 8);
      *pdVar1 = *pdVar1 - *(double *)(param_2 + (long)local_24 * 0xc80 + (long)local_28 * 8) *
                          *(double *)(param_3 + (long)local_28 * 8);
    }
    *(double *)(param_3 + (long)local_24 * 8) =
         *(double *)(param_3 + (long)local_24 * 8) /
         *(double *)(param_2 + (long)local_24 * 0xc80 + (long)local_24 * 8);
  }
  return;
}
