...

{
  ...
  pvVar3 = (void *)_polybench_alloc_data(0x93a8,8);
  pvVar4 = (void *)_polybench_alloc_data(0x9bdc,8);
  pvVar5 = (void *)_polybench_alloc_data(0xa348,8);
  pvVar6 = (void *)_polybench_alloc_data(0x9ab0,8);
  _init_array(local_24,local_28,local_2c,local_30,&local_38,&local_40,pvVar3,pvVar4,pvVar5,pvVar6);
  _polybench_timer_start();
  _kernel_2mm(local_38,local_40,local_24,local_28,local_2c,local_30,pvVar2,pvVar3,pvVar4,pvVar5,
              pvVar6);
  _polybench_timer_stop();
  _polybench_timer_print();
  if ((0x2a < local_14) && (iVar1 = __stubs::_strcmp(*local_20,""), iVar1 == 0)) {
    _print_array(local_24,local_30,pvVar6);
  }
...
void _init_array(int param_1,int param_2,int param_3,int param_4,undefined8 *param_5,
  ...
  *param_6 = 0x3ff3333333333333;
  for (local_44 = 0; local_44 < param_1; local_44 = local_44 + 1) {
    for (local_48 = 0; local_48 < param_3; local_48 = local_48 + 1) {
      iVar1 = local_44 * local_48 + 1;
      iVar2 = 0;
      if (param_1 != 0) {
        iVar2 = iVar1 / param_1;
      }
      *(double *)(param_7 + (long)local_44 * 0x690 + (long)local_48 * 8) =
           (double)(iVar1 - iVar2 * param_1) / (double)(long)param_1;
    }
  }
  for (local_44 = 0; local_44 < param_3; local_44 = local_44 + 1) {
    for (local_48 = 0; local_48 < param_2; local_48 = local_48 + 1) {
      ...
      *(double *)(param_8 + (long)local_44 * 0x5f0 + (long)local_48 * 8) =
           (double)(iVar1 - iVar2 * param_2) / (double)(long)param_2;
    }
  }
  for (local_44 = 0; local_44 < param_2; local_44 = local_44 + 1) {
    for (local_48 = 0; local_48 < param_4; local_48 = local_48 + 1) {
      iVar1 = local_44 * (local_48 + 3) + 1;
      iVar2 = 0;
      if (param_4 != 0) {
        iVar2 = iVar1 / param_4;
      }
      *(double *)(param_9 + (long)local_44 * 0x6e0 + (long)local_48 * 8) =
           (double)(iVar1 - iVar2 * param_4) / (double)(long)param_4;
    }
  }
  for (local_44 = 0; local_44 < param_1; local_44 = local_44 + 1) {
    for (local_48 = 0; local_48 < param_4; local_48 = local_48 + 1) {
      iVar1 = local_44 * (local_48 + 2);
      iVar2 = 0;
      if (param_3 != 0) {
        iVar2 = iVar1 / param_3;
      }
      *(double *)(param_10 + (long)local_44 * 0x6e0 + (long)local_48 * 8) =
           (double)(iVar1 - iVar2 * param_3) / (double)(long)param_3;
    }
  }
  return;
}
...
void _kernel_2mm(double param_1,double param_2,int param_3,int param_4,int param_5,int param_6,
                long param_7,long param_8,long param_9_00,long param_10,long param_9)

{
  ...
  for (local_4c = 0; local_4c < param_3; local_4c = local_4c + 1) {
    for (local_50 = 0; local_50 < param_4; local_50 = local_50 + 1) {
      *(undefined8 *)(param_7 + (long)local_4c * 0x5f0 + (long)local_50 * 8) = 0;
      for (local_54 = 0; local_54 < param_5; local_54 = local_54 + 1) {
        pdVar1 = (double *)(param_7 + (long)local_4c * 0x5f0 + (long)local_50 * 8);
        *pdVar1 = *pdVar1 + param_1 * *(double *)
                                       (param_8 + (long)local_4c * 0x690 + (long)local_54 * 8) *
                            *(double *)(param_9_00 + (long)local_54 * 0x5f0 + (long)local_50 * 8);
      }
    }
  }
  for (local_4c = 0; local_4c < param_3; local_4c = local_4c + 1) {
    for (local_50 = 0; local_50 < param_6; local_50 = local_50 + 1) {
      pdVar1 = (double *)(param_9 + (long)local_4c * 0x6e0 + (long)local_50 * 8);
      *pdVar1 = *pdVar1 * param_2;
      for (local_54 = 0; local_54 < param_4; local_54 = local_54 + 1) {
        pdVar1 = (double *)(param_9 + (long)local_4c * 0x6e0 + (long)local_50 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_7 + (long)local_4c * 0x5f0 + (long)local_54 * 8) *
                            *(double *)(param_10 + (long)local_54 * 0x6e0 + (long)local_50 * 8);
      }
    }
  }
  return;
