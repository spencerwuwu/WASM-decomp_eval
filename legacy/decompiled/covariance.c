...

{
  ...
  _kernel_covariance(local_30,local_28,local_24,pvVar2,pvVar3,pvVar4);
...
void _init_array(undefined8 param_1,int param_2,double *param_3,long param_4)
  ...
  for (local_1c = 0; local_1c < 0x104; local_1c = local_1c + 1) {
    for (local_20 = 0; local_20 < 0xf0; local_20 = local_20 + 1) {
      *(double *)(param_4 + (long)local_1c * 0x780 + (long)local_20 * 8) =
           ((double)(long)local_1c * (double)(long)local_20) / 240.0;
    }
  }
  return;
}
...
void _kernel_covariance(double param_1,int param_2,int param_3,long param_4,long param_5,
                       long param_6)

{
  ...
  for (local_30 = 0; local_30 < param_2; local_30 = local_30 + 1) {
    *(undefined8 *)(param_6 + (long)local_30 * 8) = 0;
    for (local_2c = 0; local_2c < param_3; local_2c = local_2c + 1) {
      pdVar1 = (double *)(param_6 + (long)local_30 * 8);
      *pdVar1 = *pdVar1 + *(double *)(param_4 + (long)local_2c * 0x780 + (long)local_30 * 8);
    }
    pdVar1 = (double *)(param_6 + (long)local_30 * 8);
  ...
  for (local_2c = 0; local_2c < param_3; local_2c = local_2c + 1) {
    for (local_30 = 0; local_30 < param_2; local_30 = local_30 + 1) {
      pdVar1 = (double *)(param_4 + (long)local_2c * 0x780 + (long)local_30 * 8);
      *pdVar1 = *pdVar1 - *(double *)(param_6 + (long)local_30 * 8);
    }
  }
  for (local_2c = 0; local_2c < param_2; local_2c = local_2c + 1) {
    for (local_30 = local_2c; local_30 < param_2; local_30 = local_30 + 1) {
      *(undefined8 *)(param_5 + (long)local_2c * 0x780 + (long)local_30 * 8) = 0;
      for (local_34 = 0; local_34 < param_3; local_34 = local_34 + 1) {
        pdVar1 = (double *)(param_5 + (long)local_2c * 0x780 + (long)local_30 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_4 + (long)local_34 * 0x780 + (long)local_2c * 8) *
                            *(double *)(param_4 + (long)local_34 * 0x780 + (long)local_30 * 8);
      }
      pdVar1 = (double *)(param_5 + (long)local_2c * 0x780 + (long)local_30 * 8);
      *pdVar1 = *pdVar1 / (param_1 - 1.0);
      *(undefined8 *)(param_5 + (long)local_30 * 0x780 + (long)local_2c * 8) =
           *(undefined8 *)(param_5 + (long)local_2c * 0x780 + (long)local_30 * 8);
    }
  }
  return;
}
