...

{
  ...
  local_20 = param_2;
  local_14 = param_1;
  pvVar2 = (void *)_polybench_alloc_data(44000);
  pvVar3 = (void *)_polybench_alloc_data(48000,8);
  pvVar4 = (void *)_polybench_alloc_data(0xce40,8);
  _init_array(local_24,local_28,local_2c,&local_38,&local_40,pvVar2,pvVar3,pvVar4);
  _polybench_timer_start();
  _kernel_gemm(local_38,local_40,local_24,local_28,local_2c,pvVar2,pvVar3,pvVar4);
...
void _init_array(int param_1,int param_2,int param_3,undefined8 *param_4,undefined8 *param_5,
  ...
  *param_5 = 0x3ff3333333333333;
  for (local_3c = 0; local_3c < param_1; local_3c = local_3c + 1) {
    for (local_40 = 0; local_40 < param_2; local_40 = local_40 + 1) {
      ...
      *(double *)(param_6 + (long)local_3c * 0x6e0 + (long)local_40 * 8) =
...
void _kernel_gemm(double param_1,double param_2,int param_3,int param_4,int param_5,long param_6,
...

{
  ...
  for (local_3c = 0; local_3c < param_3; local_3c = local_3c + 1) {
    for (local_40 = 0; local_40 < param_4; local_40 = local_40 + 1) {
      pdVar1 = (double *)(param_6 + (long)local_3c * 0x6e0 + (long)local_40 * 8);
    ...
    for (local_44 = 0; local_44 < param_5; local_44 = local_44 + 1) {
      for (local_40 = 0; local_40 < param_4; local_40 = local_40 + 1) {
        ...
        *pdVar1 = *pdVar1 + param_1 * *(double *)
                                       (param_7 + (long)local_3c * 0x780 + (long)local_44 * 8) *
                            *(double *)(param_8 + (long)local_44 * 0x6e0 + (long)local_40 * 8);
      }
    }
  }
  return;
