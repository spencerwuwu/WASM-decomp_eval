...

{
  ...
  _init_array(400,pvVar2,pvVar3);
  _polybench_timer_start();
  _kernel_jacobi_1d(100,400,pvVar2,pvVar3);
...

{
  ...
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    *(double *)(param_2 + (long)local_1c * 8) =
         ((double)(long)local_1c + 2.0) / (double)(long)param_1;
    *(double *)(param_3 + (long)local_1c * 8) =
         ((double)(long)local_1c + 3.0) / (double)(long)param_1;
  }
  return;
}
...
void _kernel_jacobi_1d(int param_1,int param_2,long param_3,long param_4)

{
  ...
  for (local_1c = 0; local_1c < param_1; local_1c = local_1c + 1) {
    for (local_20 = 1; local_20 < param_2 + -1; local_20 = local_20 + 1) {
      *(double *)(param_4 + (long)local_20 * 8) =
           (*(double *)(param_3 + (long)(local_20 + -1) * 8) +
            *(double *)(param_3 + (long)local_20 * 8) +
           *(double *)(param_3 + (long)(local_20 + 1) * 8)) * 0.33333;
    }
    for (local_20 = 1; local_20 < param_2 + -1; local_20 = local_20 + 1) {
      *(double *)(param_3 + (long)local_20 * 8) =
           (*(double *)(param_4 + (long)(local_20 + -1) * 8) +
            *(double *)(param_4 + (long)local_20 * 8) +
           *(double *)(param_4 + (long)(local_20 + 1) * 8)) * 0.33333;
    }
  }
  return;
}
