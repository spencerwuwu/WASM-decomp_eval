...

{
  ...
  _init_array(200,0xf0,pvVar2,pvVar3,pvVar4);
  _polybench_timer_start();
  _kernel_gramschmidt(200,0xf0,pvVar2,pvVar3,pvVar4);
...
void _init_array(int param_1,int param_2,long param_3,long param_4,long param_5)

{
  ...
  for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
    for (local_28 = 0; local_28 < param_2; local_28 = local_28 + 1) {
      iVar1 = 0;
      if (param_1 != 0) {
        iVar1 = (local_24 * local_28) / param_1;
      }
      *(double *)(param_3 + (long)local_24 * 0x780 + (long)local_28 * 8) =
           ((double)(local_24 * local_28 - iVar1 * param_1) / (double)(long)param_1) * 100.0 + 10.0;
      *(undefined8 *)(param_5 + (long)local_24 * 0x780 + (long)local_28 * 8) = 0;
    }
  }
  for (local_24 = 0; local_24 < param_2; local_24 = local_24 + 1) {
    for (local_28 = 0; local_28 < param_2; local_28 = local_28 + 1) {
      *(undefined8 *)(param_4 + (long)local_24 * 0x780 + (long)local_28 * 8) = 0;
    }
  }
  return;
}
...
void _kernel_gramschmidt(int param_1,int param_2,long param_3,long param_4,long param_5)

{
  ...
  for (local_2c = 0; local_2c < param_2; local_2c = local_2c + 1) {
    ...
    for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
      local_38 = local_38 +
                 *(double *)(param_3 + (long)local_24 * 0x780 + (long)local_2c * 8) *
                 *(double *)(param_3 + (long)local_24 * 0x780 + (long)local_2c * 8);
    }
    *(double *)(param_4 + (long)local_2c * 0x780 + (long)local_2c * 8) = SQRT(local_38);
    for (local_24 = 0; local_28 = local_2c, local_24 < param_1; local_24 = local_24 + 1) {
      *(double *)(param_5 + (long)local_24 * 0x780 + (long)local_2c * 8) =
           *(double *)(param_3 + (long)local_24 * 0x780 + (long)local_2c * 8) /
           *(double *)(param_4 + (long)local_2c * 0x780 + (long)local_2c * 8);
    }
    while (local_28 = local_28 + 1, local_28 < param_2) {
      *(undefined8 *)(param_4 + (long)local_2c * 0x780 + (long)local_28 * 8) = 0;
      for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
        pdVar1 = (double *)(param_4 + (long)local_2c * 0x780 + (long)local_28 * 8);
        *pdVar1 = *pdVar1 + *(double *)(param_5 + (long)local_24 * 0x780 + (long)local_2c * 8) *
                            *(double *)(param_3 + (long)local_24 * 0x780 + (long)local_28 * 8);
      }
      for (local_24 = 0; local_24 < param_1; local_24 = local_24 + 1) {
        *(double *)(param_3 + (long)local_24 * 0x780 + (long)local_28 * 8) =
             *(double *)(param_3 + (long)local_24 * 0x780 + (long)local_28 * 8) -
             *(double *)(param_5 + (long)local_24 * 0x780 + (long)local_2c * 8) *
             *(double *)(param_4 + (long)local_2c * 0x780 + (long)local_28 * 8);
      }
    }
  }
  return;
...

{
  ...
  for (local_34 = 0; local_34 < param_2; local_34 = local_34 + 1) {
    for (local_38 = 0; local_38 < param_2; local_38 = local_38 + 1) {
      if ((local_34 * param_2 + local_38) % 0x14 == 0) {
