...
#ifndef LU_H_GENERATED_
#define LU_H_GENERATED_
...
typedef struct Z_lu_instance_t {
...
void Z_lu_instantiate(Z_lu_instance_t*, struct Z_env_instance_t*, struct Z_wasi_snapshot_preview1_instance_t*);
void Z_lu_free(Z_lu_instance_t*);
...
void Z_luZ___wasm_call_ctors(Z_lu_instance_t*);

/* export: '__main_argc_argv' */
u32 Z_luZ___main_argc_argv(Z_lu_instance_t*, u32, u32);

/* export: '__errno_location' */
u32 Z_luZ___errno_location(Z_lu_instance_t*);

/* export: '__indirect_function_table' */
wasm_rt_funcref_table_t* Z_luZ___indirect_function_table(Z_lu_instance_t* instance);

/* export: 'fflush' */
u32 Z_luZ_fflush(Z_lu_instance_t*, u32);

/* export: 'emscripten_stack_init' */
void Z_luZ_emscripten_stack_init(Z_lu_instance_t*);

/* export: 'emscripten_stack_get_free' */
u32 Z_luZ_emscripten_stack_get_free(Z_lu_instance_t*);

/* export: 'emscripten_stack_get_base' */
u32 Z_luZ_emscripten_stack_get_base(Z_lu_instance_t*);

/* export: 'emscripten_stack_get_end' */
u32 Z_luZ_emscripten_stack_get_end(Z_lu_instance_t*);

/* export: 'stackSave' */
u32 Z_luZ_stackSave(Z_lu_instance_t*);

/* export: 'stackRestore' */
void Z_luZ_stackRestore(Z_lu_instance_t*, u32);

/* export: 'stackAlloc' */
u32 Z_luZ_stackAlloc(Z_lu_instance_t*, u32);

/* export: 'emscripten_stack_get_current' */
u32 Z_luZ_emscripten_stack_get_current(Z_lu_instance_t*);

/* export: 'dynCall_jiji' */
u32 Z_luZ_dynCall_jiji(Z_lu_instance_t*, u32, u32, u32, u32, u32);

#ifdef __cplusplus
}
#endif

#endif  /* LU_H_GENERATED_ */
