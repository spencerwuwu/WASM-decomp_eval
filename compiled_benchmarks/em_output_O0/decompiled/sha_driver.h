...
typedef struct Z_sha_driver_instance_t {
...
void Z_sha_driverZ___wasm_call_ctors(Z_sha_driver_instance_t*);

/* export: '__main_argc_argv' */
u32 Z_sha_driverZ___main_argc_argv(Z_sha_driver_instance_t*, u32, u32);

/* export: '__errno_location' */
u32 Z_sha_driverZ___errno_location(Z_sha_driver_instance_t*);

/* export: '__indirect_function_table' */
wasm_rt_funcref_table_t* Z_sha_driverZ___indirect_function_table(Z_sha_driver_instance_t* instance);

/* export: 'fflush' */
u32 Z_sha_driverZ_fflush(Z_sha_driver_instance_t*, u32);

/* export: 'emscripten_stack_init' */
void Z_sha_driverZ_emscripten_stack_init(Z_sha_driver_instance_t*);

/* export: 'emscripten_stack_get_free' */
u32 Z_sha_driverZ_emscripten_stack_get_free(Z_sha_driver_instance_t*);

/* export: 'emscripten_stack_get_base' */
u32 Z_sha_driverZ_emscripten_stack_get_base(Z_sha_driver_instance_t*);

/* export: 'emscripten_stack_get_end' */
u32 Z_sha_driverZ_emscripten_stack_get_end(Z_sha_driver_instance_t*);

/* export: 'stackSave' */
u32 Z_sha_driverZ_stackSave(Z_sha_driver_instance_t*);

/* export: 'stackRestore' */
void Z_sha_driverZ_stackRestore(Z_sha_driver_instance_t*, u32);

/* export: 'stackAlloc' */
u32 Z_sha_driverZ_stackAlloc(Z_sha_driver_instance_t*, u32);

/* export: 'emscripten_stack_get_current' */
u32 Z_sha_driverZ_emscripten_stack_get_current(Z_sha_driver_instance_t*);

/* export: 'dynCall_jiji' */
u32 Z_sha_driverZ_dynCall_jiji(Z_sha_driver_instance_t*, u32, u32, u32, u32, u32);
