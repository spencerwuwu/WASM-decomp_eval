...
typedef struct Z_bicg_instance_t {
...
void Z_bicg_instantiate(Z_bicg_instance_t*, struct Z_env_instance_t*, struct Z_wasi_snapshot_preview1_instance_t*);
void Z_bicg_free(Z_bicg_instance_t*);
...
void Z_bicgZ___wasm_call_ctors(Z_bicg_instance_t*);

/* export: '__main_argc_argv' */
u32 Z_bicgZ___main_argc_argv(Z_bicg_instance_t*, u32, u32);

/* export: '__errno_location' */
u32 Z_bicgZ___errno_location(Z_bicg_instance_t*);

/* export: '__indirect_function_table' */
wasm_rt_funcref_table_t* Z_bicgZ___indirect_function_table(Z_bicg_instance_t* instance);

/* export: 'fflush' */
u32 Z_bicgZ_fflush(Z_bicg_instance_t*, u32);

/* export: 'emscripten_stack_init' */
void Z_bicgZ_emscripten_stack_init(Z_bicg_instance_t*);

/* export: 'emscripten_stack_get_free' */
u32 Z_bicgZ_emscripten_stack_get_free(Z_bicg_instance_t*);

/* export: 'emscripten_stack_get_base' */
u32 Z_bicgZ_emscripten_stack_get_base(Z_bicg_instance_t*);

/* export: 'emscripten_stack_get_end' */
u32 Z_bicgZ_emscripten_stack_get_end(Z_bicg_instance_t*);

/* export: 'stackSave' */
u32 Z_bicgZ_stackSave(Z_bicg_instance_t*);

/* export: 'stackRestore' */
void Z_bicgZ_stackRestore(Z_bicg_instance_t*, u32);

/* export: 'stackAlloc' */
u32 Z_bicgZ_stackAlloc(Z_bicg_instance_t*, u32);

/* export: 'emscripten_stack_get_current' */
u32 Z_bicgZ_emscripten_stack_get_current(Z_bicg_instance_t*);

/* export: 'dynCall_jiji' */
u32 Z_bicgZ_dynCall_jiji(Z_bicg_instance_t*, u32, u32, u32, u32, u32);
