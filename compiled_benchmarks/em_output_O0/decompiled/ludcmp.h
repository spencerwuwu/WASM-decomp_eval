...
typedef struct Z_ludcmp_instance_t {
...
void Z_ludcmp_instantiate(Z_ludcmp_instance_t*, struct Z_env_instance_t*, struct Z_wasi_snapshot_preview1_instance_t*);
void Z_ludcmp_free(Z_ludcmp_instance_t*);
...
void Z_ludcmpZ___wasm_call_ctors(Z_ludcmp_instance_t*);

/* export: '__main_argc_argv' */
u32 Z_ludcmpZ___main_argc_argv(Z_ludcmp_instance_t*, u32, u32);

/* export: '__errno_location' */
u32 Z_ludcmpZ___errno_location(Z_ludcmp_instance_t*);

/* export: '__indirect_function_table' */
wasm_rt_funcref_table_t* Z_ludcmpZ___indirect_function_table(Z_ludcmp_instance_t* instance);

/* export: 'fflush' */
u32 Z_ludcmpZ_fflush(Z_ludcmp_instance_t*, u32);

/* export: 'emscripten_stack_init' */
void Z_ludcmpZ_emscripten_stack_init(Z_ludcmp_instance_t*);

/* export: 'emscripten_stack_get_free' */
u32 Z_ludcmpZ_emscripten_stack_get_free(Z_ludcmp_instance_t*);

/* export: 'emscripten_stack_get_base' */
u32 Z_ludcmpZ_emscripten_stack_get_base(Z_ludcmp_instance_t*);

/* export: 'emscripten_stack_get_end' */
u32 Z_ludcmpZ_emscripten_stack_get_end(Z_ludcmp_instance_t*);

/* export: 'stackSave' */
u32 Z_ludcmpZ_stackSave(Z_ludcmp_instance_t*);

/* export: 'stackRestore' */
void Z_ludcmpZ_stackRestore(Z_ludcmp_instance_t*, u32);

/* export: 'stackAlloc' */
u32 Z_ludcmpZ_stackAlloc(Z_ludcmp_instance_t*, u32);

/* export: 'emscripten_stack_get_current' */
u32 Z_ludcmpZ_emscripten_stack_get_current(Z_ludcmp_instance_t*);

/* export: 'dynCall_jiji' */
u32 Z_ludcmpZ_dynCall_jiji(Z_ludcmp_instance_t*, u32, u32, u32, u32, u32);
